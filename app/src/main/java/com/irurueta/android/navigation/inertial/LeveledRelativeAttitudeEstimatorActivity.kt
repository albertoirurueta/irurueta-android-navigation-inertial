...
import com.irurueta.android.navigation.inertial.estimators.LeveledRelativeAttitudeEstimator
...
class LeveledRelativeAttitudeEstimatorActivity : AppCompatActivity() {
        ...
        if (location != null) {
            ...
            if (lastLocation != null) {
                ...
                locationService?.getCurrentLocation { currentLocation ->
                    this@LeveledRelativeAttitudeEstimatorActivity.location = currentLocation
                    buildEstimatorAndStart()
                }
            }
        }
    ...
    private fun buildEstimatorAndStart() {
        ...
        if (leveledAttitudeEstimator?.running == true) return

        if (leveledAttitudeEstimator != null) {
            leveledAttitudeEstimator?.location = location
        } else {
