...
import com.irurueta.android.navigation.inertial.old.estimators.pose.EcefAbsolutePoseEstimator2
...
class PoseEstimatorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.irurueta.android.navigation.inertial.app.R.layout.activity_pose_estimator)
    ...
    private fun buildEstimatorAndStart() {
        ...
        poseEstimator = EcefAbsolutePoseEstimator2(
            this,
            location,
