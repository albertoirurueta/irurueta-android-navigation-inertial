...
android {
    namespace = "com.irurueta.android.navigation.inertial.app"
    compileSdk = 36
...
sonar {
    properties {
        ...
        property("sonar.projectName", "irurueta-android-navigation-inertial-${project.name}")
        ...
        property("sonar.java.binaries", "build/intermediates/javac/compileDebugJavaWithJavac/debug/classes,build/tmp/kotlin-classes/debug")
...
dependencies {
    ...
    implementation(libs.irurueta.gl.utils)
    implementation(libs.irurueta.gl.cube)
