...
//    @MockK(relaxUnitFun = true)
    ...
    private lateinit var accuracyChangedListener:
            SensorCollector2.OnAccuracyChangedListener<GyroscopeSensorMeasurement, GyroscopeSensorCollector2>

//    @MockK(relaxUnitFun = true)
    @Mock
    private lateinit var measurementListener:
            SensorCollector2.OnMeasurementListener<GyroscopeSensorMeasurement, GyroscopeSensorCollector2>
...
//        every { contextSpy.getSystemService(Context.SENSOR_SERVICE) }.returns(sensorManagerSpy)
        ...
        verify(measurementListener, only()).onMeasurement(eq(collector), capture(gyroscopeSensorMeasurementCaptor))
