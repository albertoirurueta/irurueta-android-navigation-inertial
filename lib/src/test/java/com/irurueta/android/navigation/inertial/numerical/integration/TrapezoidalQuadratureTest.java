...
public class TrapezoidalQuadratureTest {
    ...
    public void next_returnsNotZeroValue() throws EvaluationException {
        ...
        final double b = randomizer.nextDouble(MIN_VALUE, MAX_VALUE);

        final Polynomial polynomial = buildPolynomial();

        final TrapezoidalQuadrature quadrature = new TrapezoidalQuadrature(a, b,
    ...
    public void getType_returnsExpectedValue() {
        final TrapezoidalQuadrature quadrature = new TrapezoidalQuadrature(0.0, 1.0, null);
        assertEquals(QuadratureType.TRAPEZOIDAL, quadrature.getType());
    }
