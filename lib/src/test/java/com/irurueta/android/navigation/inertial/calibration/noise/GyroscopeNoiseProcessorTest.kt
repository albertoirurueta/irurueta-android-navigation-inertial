...
class GyroscopeNoiseProcessorTest {

    @Test
    fun constructor_whenDefaultValues_setsExpectedValues() {
        val processor = GyroscopeNoiseProcessor()
        ...
        assertFalse(processor.getAverageXAsMeasurement(angularSpeed))
        assertNull(processor.averageY)
        assertNull(processor.averageYAsMeasurement)
        assertFalse(processor.getAverageYAsMeasurement(angularSpeed))
        assertNull(processor.averageZ)
        assertNull(processor.averageZAsMeasurement)
        assertFalse(processor.getAverageZAsMeasurement(angularSpeed))
        ...
        assertFalse(processor.getAverageNormAsMeasurement(angularSpeed))
        ...
        assertFalse(processor.getStandardDeviationXAsMeasurement(angularSpeed))
        assertNull(processor.standardDeviationY)
        assertNull(processor.standardDeviationYAsMeasurement)
        assertFalse(processor.getStandardDeviationYAsMeasurement(angularSpeed))
        assertNull(processor.standardDeviationZ)
        assertNull(processor.standardDeviationZAsMeasurement)
        assertFalse(processor.getStandardDeviationZAsMeasurement(angularSpeed))
        ...
        assertFalse(processor.getStandardDeviationNormAsMeasurement(angularSpeed))
        assertNull(processor.averageStandardDeviation)
        assertNull(processor.averageStandardDeviationAsMeasurement)
        assertFalse(processor.getAverageStandardDeviationAsMeasurement(angularSpeed))
    ...
    fun constructor_whenNegativeMaxSamples_throwsIllegalArgumentException() {
        assertThrows(IllegalArgumentException::class.java) {
            GyroscopeNoiseProcessor(-1)
        }
    }

    @Test
    fun constructor_whenMaxSamples_setsExpectedValues() {
        val processor = GyroscopeNoiseProcessor(MAX_SAMPLES)
    ...
    fun constructor_whenNegativeMaxDurationMillis_throwsIllegalArgumentException() {
        assertThrows(IllegalArgumentException::class.java) {
            GyroscopeNoiseProcessor(maxDurationMillis = -1L)
        }
    }
    ...
    fun averageXAsMeasurement_whenResultAvailable_returnsExpectedValue() {
        ...
        assertEquals(AngularSpeedUnit.RADIANS_PER_SECOND, averageXAsMeasurement.unit)
    }
    ...
    fun averageYAsMeasurement_whenResultAvailable_returnsExpectedValue() {
        ...
        assertEquals(AngularSpeedUnit.RADIANS_PER_SECOND, averageYAsMeasurement.unit)
    }
    ...
    fun averageZAsMeasurement_whenResultAvailable_returnsExpectedValue() {
        ...
        assertEquals(AngularSpeedUnit.RADIANS_PER_SECOND, averageZAsMeasurement.unit)
    }
    ...
    fun averageTriad_whenResultAvailable_returnsExpectedValue() {
        ...
        assertEquals(AngularSpeedUnit.RADIANS_PER_SECOND, averageTriad.unit)
    }
    ...
    fun averageNormAsMeasurement_whenResultAvailable_returnsExpectedValue() {
        ...
        assertEquals(AngularSpeedUnit.RADIANS_PER_SECOND, averageNormAsMeasurement.unit)
    }
    ...
    fun getStandardDeviationNormAsMeasurement_whenResultAvailable_returnsTrue() {
        ...
        assertEquals(
            standardDeviationNorm, result.value.toDouble(),
    ...
    fun process_whenFirstMeasurement_setsInitialTimestamp() {
        ...
        val measurement = GyroscopeSensorMeasurement(wx, wy, wz, timestamp = timestamp)
    ...
    fun process_whenSecondMeasurement_updatesValues() {
        ...
        val measurement1 = GyroscopeSensorMeasurement(wx1, wy1, wz1, timestamp = timestamp1)
        ...
        assertEquals(nedMeasurement1.wx.toDouble(), noiseEstimator.avgX, 0.0)
        assertEquals(nedMeasurement1.wy.toDouble(), noiseEstimator.avgY, 0.0)
        assertEquals(nedMeasurement1.wz.toDouble(), noiseEstimator.avgZ, 0.0)
        ...
        val measurement2 = GyroscopeSensorMeasurement(wx2, wy2, wz2, timestamp = timestamp2)
        ...
        assertEquals(0.0, timeIntervalEstimator.averageTimeInterval, 0.0)
        val avgX2 = 0.5 * (nedMeasurement1.wx.toDouble() + nedMeasurement2.wx.toDouble())
        assertEquals(avgX2, noiseEstimator.avgX, ABSOLUTE_ERROR)
        val avgY2 = 0.5 * (nedMeasurement1.wy.toDouble() + nedMeasurement2.wy.toDouble())
        assertEquals(avgY2, noiseEstimator.avgY, ABSOLUTE_ERROR)
        val avgZ2 = 0.5 * (nedMeasurement1.wz.toDouble() + nedMeasurement2.wz.toDouble())
        assertEquals(avgZ2, noiseEstimator.avgZ, ABSOLUTE_ERROR)
        assertEquals(
            (nedMeasurement2.wx.toDouble() - avgX2).pow(2.0) / 2.0,
            noiseEstimator.varianceX,
            ABSOLUTE_ERROR
        )
        assertEquals(
            (nedMeasurement2.wy.toDouble() - avgY2).pow(2.0) / 2.0,
            noiseEstimator.varianceY,
            ABSOLUTE_ERROR
        )
        assertEquals(
            (nedMeasurement2.wz.toDouble() - avgZ2).pow(2.0) / 2.0,
    ...
    fun process_whenThirdMeasurement_updatesValues() {
        ...
        val wx3 = randomizer.nextFloat()
        val wy3 = randomizer.nextFloat()
        val wz3 = randomizer.nextFloat()
        val timestamp3 = timestamp2 + TIME_INTERVAL_MILLIS * MILLIS_TO_NANOS
        val measurement3 = GyroscopeSensorMeasurement(wx3, wy3, wz3, timestamp = timestamp3)
        ...
        val avgX3 =
            (nedMeasurement1.wx.toDouble() + nedMeasurement2.wx.toDouble() + nedMeasurement3.wx.toDouble()) / 3.0
        assertEquals(avgX3, noiseEstimator.avgX,
            ABSOLUTE_ERROR
        )
        val avgY3 =
            (nedMeasurement1.wy.toDouble() + nedMeasurement2.wy.toDouble() + nedMeasurement3.wy.toDouble()) / 3.0
        assertEquals(avgY3, noiseEstimator.avgY,
            ABSOLUTE_ERROR
        )
        val avgZ3 =
            (nedMeasurement1.wz.toDouble() + nedMeasurement2.wz.toDouble() + nedMeasurement3.wz.toDouble()) / 3.0
        assertEquals(avgZ3, noiseEstimator.avgZ,
            ABSOLUTE_ERROR
        )
    }
    ...
    fun process_whenIsCompleteMaxSamplesOnly_returnsTrue() {
        ...
        requireNotNull(avgX)
        assertEquals(wx.toDouble(), avgX, ABSOLUTE_ERROR)
        val avgY = processor.averageY
        requireNotNull(avgY)
        assertEquals(wy.toDouble(), avgY, ABSOLUTE_ERROR)
        val avgZ = processor.averageZ
        requireNotNull(avgZ)
        assertEquals(wz.toDouble(), avgZ, ABSOLUTE_ERROR)
