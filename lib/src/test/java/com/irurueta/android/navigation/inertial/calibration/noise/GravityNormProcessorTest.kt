...
class GravityNormProcessorTest {

    @Test
    fun constructor_whenDefaultValues_setsExpectedValues() {
        val processor = GravityNormProcessor()
        ...
        assertFalse(processor.getNormStandardDeviationAsMeasurement(acceleration))
    ...
    fun constructor_whenNegativeMaxSamples_throwsIllegalArgumentException() {
        assertThrows(IllegalArgumentException::class.java) {
            GravityNormProcessor(-1)
        }
    }

    @Test
    fun constructor_whenMaxSamples_setsExpectedValues() {
        val processor = GravityNormProcessor(MAX_SAMPLES)
    ...
    fun constructor_whenNegativeMaxDurationMillis_throwsIllegalArgumentException() {
        assertThrows(IllegalArgumentException::class.java) {
            GravityNormProcessor(maxDurationMillis = -1L)
        }
    }
    ...
    fun getTimeIntervalStandardDeviationAsTime_whenResultAvailable_returnsTrue() {
        ...
        assertEquals(timeIntervalStandardDeviation, result.value.toDouble(),
            ABSOLUTE_ERROR
        )
        assertEquals(TimeUnit.SECOND, result.unit)
    }
    ...
    fun elapsedTimeNanos_returnsExpectedValue() {
        ...
        setPrivateProperty(BaseAccumulatedProcessor::class, processor,
    ...
    fun normStandardDeviationAsMeasurement_whenResultAvailable_returnsExpectedValue() {
        ...
        assertEquals(
            ...
            normStandardDeviationAsMeasurement.value.toDouble(), ABSOLUTE_ERROR
        )
        assertEquals(AccelerationUnit.METERS_PER_SQUARED_SECOND, normStandardDeviationAsMeasurement.unit)
    }
    ...
    fun process_whenFirstMeasurement_setsInitialTimestamp() {
        ...
        val measurement = GravitySensorMeasurement(gx, gy, gz, timestamp = timestamp)
    ...
    fun process_whenSecondMeasurement_updatesValues() {
        ...
        val measurement1 = GravitySensorMeasurement(gx1, gy1, gz1, timestamp = timestamp1)
        ...
        val measurement2 = GravitySensorMeasurement(gx2, gy2, gz2, timestamp = timestamp2)
    ...
    fun process_whenThirdMeasurement_updatesValues() {
        ...
        val gx3 = randomizer.nextFloat()
        val gy3 = randomizer.nextFloat()
        val gz3 = randomizer.nextFloat()
        val timestamp3 = timestamp2 + TIME_INTERVAL_MILLIS * MILLIS_TO_NANOS
        val measurement3 = GravitySensorMeasurement(gx3, gy3, gz3, timestamp = timestamp3)
    ...
    fun reset_whenMaxDurationOnlyStopMode_resetsValues() {
        val processor = GravityNormProcessor(stopMode = StopMode.MAX_DURATION_ONLY)
    ...
    fun reset_whenOtherStopMode_resetsValues() {
        val processor = GravityNormProcessor(stopMode = StopMode.MAX_SAMPLES_ONLY)
        val maxSamples = processor.maxSamples
