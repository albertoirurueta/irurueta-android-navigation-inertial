...
class GyroscopeSensorMeasurementInterpolatorTest {

    @get:Rule
    val mockkRule = MockKRule(this)

    private val interpolator = GyroscopeSensorMeasurementInterpolator()
    ...
    fun interpolate_whenEmptyMeasurements_returnsFalse() {
        val result = mockk<GyroscopeSensorMeasurement>()
    ...
    fun interpolate_whenTimestampBetweenMeasurements_returnsExpectedMeasurement() {
        ...
        val wx = measurement1.wx + alpha * (measurement2.wx - measurement1.wx)
        val wy = measurement1.wy + alpha * (measurement2.wy - measurement1.wy)
        val wz = measurement1.wz + alpha * (measurement2.wz - measurement1.wz)
        ...
        assertEquals(wx, result.wx, ABSOLUTE_ERROR)
        assertEquals(wy, result.wy, ABSOLUTE_ERROR)
        assertEquals(wz, result.wz, ABSOLUTE_ERROR)
        ...
        assertEquals(GyroscopeSensorType.GYROSCOPE_UNCALIBRATED, result.sensorType)
    ...
    fun interpolate_whenTimestampInFirstMeasurement_returnsExpectedMeasurement() {
        ...
        val wx = measurement1.wx
        val wy = measurement1.wy
        val wz = measurement1.wz
    ...
    companion object {
        ...
        private fun createMeasurement(withBias: Boolean = true): GyroscopeSensorMeasurement {
