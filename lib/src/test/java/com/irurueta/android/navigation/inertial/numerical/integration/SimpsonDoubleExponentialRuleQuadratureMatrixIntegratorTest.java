...
public class SimpsonDoubleExponentialRuleQuadratureMatrixIntegratorTest {
    ...
    public void constructor_makesNewInstance() throws WrongSizeException {
        ...
        final SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator integrator1 =
                new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(a, b, HMAX, listener,
                        EPS);

        assertNotNull(integrator1);

        final SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator integrator2 =
                new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(a, b, listener, EPS);

        assertNotNull(integrator2);

        final SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator integrator3 =
                new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(a, b, HMAX, listener);

        assertNotNull(integrator3);

        final SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator integrator4 =
                new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(a, b, listener);

        assertNotNull(integrator4);

        final SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator integrator5 =
                new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(a, b, HMAX, listener,
                        EPS);

        assertNotNull(integrator5);

        final SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator integrator6 =
                new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(a, b, listener, EPS);

        assertNotNull(integrator6);

        final SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator integrator7 =
                new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(a, b, HMAX, listener);

        assertNotNull(integrator7);

        final SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator integrator8 =
                new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(a, b, listener);
    ...
    public void integrate_whenGaussian_returnsExpectedResult()
        ...
        final SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator integrator =
                new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(a, b, listener);
    ...
    public void integrate_whenImproperIntegrandWithSingularities_throwsIntegrationException()
        ...
        final SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator integrator =
                new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(0.0, ALMOST_INFINITY,
                        listener);
    ...
    public void getIntegratorType_returnsExpectedValue() throws WrongSizeException {
        ...
        final SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator integrator =
                new SimpsonDoubleExponentialRuleQuadratureMatrixIntegrator(0.0, 1.0, listener);
