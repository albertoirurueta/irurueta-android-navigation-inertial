...
public class RombergMidPointQuadratureMatrixIntegratorTest {
    ...
    private static final double ABSOLUTE_ERROR_EXPONENTIAL = 2e-5;
    ...
    public void integrate_whenGaussian_returnsExpectedResult()
        ...
        final RombergMidPointQuadratureMatrixIntegrator integrator =
                new RombergMidPointQuadratureMatrixIntegrator(a, b, listener);
    ...
    public void integrate_whenImproperIntegrandWithSingularities_returnsExpectedResult()
        ...
        final RombergMidPointQuadratureMatrixIntegrator integrator =
                new RombergMidPointQuadratureMatrixIntegrator(0.0, 1.0, listener);
    ...
    public void integrate_whenImproperIntegralFromZeroToInfinity3_returnsWrongResult()
        ...
        final RombergMidPointQuadratureMatrixIntegrator integrator =
                new RombergMidPointQuadratureMatrixIntegrator(0.0, ALMOST_INFINITY, listener);
