...
class AccelerometerSensorMeasurementTriadConverterTest {
    ...
    fun convert_whenNoBias_returnsExpectedTriad() {
        ...
        AccelerometerSensorMeasurementTriadConverter.convert(measurement, triad1)
        val triad2 = AccelerometerSensorMeasurementTriadConverter.convert(measurement)
