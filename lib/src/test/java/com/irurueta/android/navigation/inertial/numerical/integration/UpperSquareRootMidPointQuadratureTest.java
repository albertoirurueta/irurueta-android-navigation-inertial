...
public class UpperSquareRootMidPointQuadratureTest {
    ...
    public void getType_returnsExpectedValue() {
        final UpperSquareRootMidPointQuadrature quadrature =
                new UpperSquareRootMidPointQuadrature(0.0, 1.0, null);
        assertEquals(QuadratureType.UPPER_SQUARE_ROOT_MID_POINT, quadrature.getType());
    }
