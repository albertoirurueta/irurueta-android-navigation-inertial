...
public class RombergUpperSquareRootMidPointQuadratureMatrixIntegratorTest {
    ...
    public void integrate_whenGaussian_returnsExpectedResult()
        ...
        final RombergUpperSquareRootMidPointQuadratureMatrixIntegrator integrator =
    ...
    public void integrate_whenImproperIntegrandWithSingularities_returnsExpectedResult()
        ...
        final RombergUpperSquareRootMidPointQuadratureMatrixIntegrator integrator =
                new RombergUpperSquareRootMidPointQuadratureMatrixIntegrator(0.0, 1.0, listener);
    ...
    public void integrate_whenImproperIntegralFromZeroToInfinity3_returnsWrongResult()
        ...
        final RombergUpperSquareRootMidPointQuadratureMatrixIntegrator integrator =
                new RombergUpperSquareRootMidPointQuadratureMatrixIntegrator(0.0, ALMOST_INFINITY,
                        listener);
