...
class LocalPoseEstimatorTest {
    ...
    @MockK(relaxUnitFun = true)
    private lateinit var accuracyChangedListener: LocalPoseEstimator.OnAccuracyChangedListener
    ...
    fun constructor_whenRequiredProperties_setsDefaultValues() {
        ...
        val estimator = LocalPoseEstimator(context, initialLocation)
    ...
    fun initialLocation_whenUseAttitudeSensor_returnsExpectedValue() {
        val initialLocation = getLocation()
        val estimator = LocalPoseEstimator(context, initialLocation, useAttitudeSensor = true)
    ...
    fun attitudeOutlierPanicThreshold_setsExpectedValue() {
        ...
        // check default value
        assertEquals(
            com.irurueta.android.navigation.inertial.old.processors.attitude.BaseFusedGeomagneticAttitudeProcessor.DEFAULT_OUTLIER_PANIC_THRESHOLD,
    ...
    fun timeIntervalSeconds_whenUseAttitudeSensor_returnsNull() {
        val initialLocation = getLocation()
        val estimator =
            LocalPoseEstimator(context, initialLocation, useAttitudeSensor = true)
    ...
    fun start_whenNotUseAttitudeSensorUseAccelerometerForAttitudeEstimationAndNotUseDoubleFusedAttitudeProcessor_resetsProcessorAndStartsSyncer() {
        ...
        val accelerometerFusedCollector: AccelerometerGyroscopeAndMagnetometerSyncedSensorCollector? =
            estimator.getPrivateProperty("accelerometerFusedCollector")
        requireNotNull(accelerometerFusedCollector)
        val accelerometerFusedSyncerSpy = spyk(accelerometerFusedCollector)
        every { accelerometerFusedSyncerSpy.start(startTimestamp) }.returns(true)
        estimator.setPrivateProperty("accelerometerFusedCollector", accelerometerFusedSyncerSpy)
    ...
    fun stop_stopsAllSyncers() {
        ...
        val fusedCollector: AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector? =
            estimator.getPrivateProperty("fusedCollector")
        requireNotNull(fusedCollector)
        val fusedSyncerSpy = spyk(fusedCollector)
        every { fusedSyncerSpy.start(startTimestamp) }.returns(true)
        estimator.setPrivateProperty("fusedCollector", fusedSyncerSpy)
    ...
    @Test
    fun accelerometerFusedCollector_whenSyncedMeasurementUseDoubleFusedAttitudeProcessedNotEstimatePoseTransformationAndNoListener_makesExpectedCalls() {
        val initialLocation = getLocation()
        val estimator = LocalPoseEstimator(
            context,
            initialLocation,
    ...
    @Test
    fun accelerometerFusedCollector_whenSyncedMeasurementUseDoubleFusedAttitudeProcessedEstimatePoseTransformationAndNoListener_makesExpectedCalls() {
        val initialLocation = getLocation()
        val estimator = LocalPoseEstimator(
            context,
            initialLocation,
    ...
    @Test
    fun attitudeCollector_whenSyncedMeasurementUseDoubleFusedAttitudeProcessedEstimatePoseTransformationAndListener_makesExpectedCalls() {
        val initialLocation = getLocation()
        val estimator = LocalPoseEstimator(
            context,
            initialLocation,
