...
class MagnetometerNoiseProcessorTest {

    @Test
    fun constructor_whenDefaultValues_setsExpectedValues() {
        val processor = MagnetometerNoiseProcessor()
        ...
        assertFalse(processor.getAverageXAsMeasurement(magneticFluxDensity))
        assertNull(processor.averageY)
        assertNull(processor.averageYAsMeasurement)
        assertFalse(processor.getAverageYAsMeasurement(magneticFluxDensity))
        assertNull(processor.averageZ)
        assertNull(processor.averageZAsMeasurement)
        assertFalse(processor.getAverageZAsMeasurement(magneticFluxDensity))
        ...
        assertFalse(processor.getStandardDeviationXAsMeasurement(magneticFluxDensity))
        assertNull(processor.standardDeviationY)
        assertNull(processor.standardDeviationYAsMeasurement)
        assertFalse(processor.getStandardDeviationYAsMeasurement(magneticFluxDensity))
        assertNull(processor.standardDeviationZ)
        assertNull(processor.standardDeviationZAsMeasurement)
        assertFalse(processor.getStandardDeviationZAsMeasurement(magneticFluxDensity))
        ...
        assertFalse(processor.getStandardDeviationNormAsMeasurement(magneticFluxDensity))
        assertNull(processor.averageStandardDeviation)
        assertNull(processor.averageStandardDeviationAsMeasurement)
        assertFalse(processor.getAverageStandardDeviationAsMeasurement(magneticFluxDensity))
    ...
    fun constructor_whenNegativeMaxSamples_throwsIllegalArgumentException() {
        assertThrows(IllegalArgumentException::class.java) {
            MagnetometerNoiseProcessor(-1)
        }
    }

    @Test
    fun constructor_whenMaxSamples_setsExpectedValues() {
        val processor = MagnetometerNoiseProcessor(MAX_SAMPLES)
    ...
    fun constructor_whenNegativeMaxDurationMillis_throwsIllegalArgumentException() {
        assertThrows(IllegalArgumentException::class.java) {
            MagnetometerNoiseProcessor(maxDurationMillis = -1L)
        }
    }
    ...
    fun timeIntervalStandardDeviation_whenResultAvailable_returnsExpectedValue() {
        ...
        assertEquals(timeIntervalStandardDeviation, result,
            ABSOLUTE_ERROR
        )
    }
    ...
    fun averageXAsMeasurement_whenResultAvailable_returnsExpectedValue() {
        ...
        assertEquals(MagneticFluxDensityUnit.TESLA, averageXAsMeasurement.unit)
    }
    ...
    fun averageYAsMeasurement_whenResultAvailable_returnsExpectedValue() {
        ...
        assertEquals(MagneticFluxDensityUnit.TESLA, averageYAsMeasurement.unit)
    }
    ...
    fun averageZAsMeasurement_whenResultAvailable_returnsExpectedValue() {
        ...
        assertEquals(MagneticFluxDensityUnit.TESLA, averageZAsMeasurement.unit)
    }
    ...
    fun averageTriad_whenResultAvailable_returnsExpectedValue() {
        ...
        assertEquals(MagneticFluxDensityUnit.TESLA, averageTriad.unit)
    }
    ...
    fun standardDeviationX_whenResultAvailable_returnsExpectedValue() {
        ...
        requireNotNull(result)
        assertEquals(standardDeviationX, result,
            ABSOLUTE_ERROR
        )
    }
    ...
    fun standardDeviationY_whenResultAvailable_returnsExpectedValue() {
        ...
        requireNotNull(result)
        assertEquals(standardDeviationY, result,
            ABSOLUTE_ERROR
        )
    }
    ...
    fun getStandardDeviationNormAsMeasurement_whenResultAvailable_returnsTrue() {
        ...
        assertEquals(standardDeviationNorm, result.value.toDouble(),
    ...
    fun process_whenSecondMeasurement_updatesValues() {
        ...
        assertEquals(MagneticFluxDensityConverter.microTeslaToTesla(
            nedMeasurement1.bx.toDouble()), noiseEstimator.avgX, 0.0)
        assertEquals(MagneticFluxDensityConverter.microTeslaToTesla(
                nedMeasurement1.by.toDouble()), noiseEstimator.avgY, 0.0)
        assertEquals(MagneticFluxDensityConverter.microTeslaToTesla(
            nedMeasurement1.bz.toDouble()), noiseEstimator.avgZ, 0.0)
        ...
        assertEquals(0.0, timeIntervalEstimator.averageTimeInterval, 0.0)
        val avgX2 = MagneticFluxDensityConverter.microTeslaToTesla(
            0.5 * (nedMeasurement1.bx.toDouble() + nedMeasurement2.bx.toDouble()))
        assertEquals(avgX2, noiseEstimator.avgX,
            ABSOLUTE_ERROR
        )
        val avgY2 = MagneticFluxDensityConverter.microTeslaToTesla(
            0.5 * (nedMeasurement1.by.toDouble() + nedMeasurement2.by.toDouble()))
        assertEquals(avgY2, noiseEstimator.avgY,
            ABSOLUTE_ERROR
        )
        val avgZ2 = MagneticFluxDensityConverter.microTeslaToTesla(
            0.5 * (nedMeasurement1.bz.toDouble() + nedMeasurement2.bz.toDouble()))
        assertEquals(avgZ2, noiseEstimator.avgZ,
            ABSOLUTE_ERROR
        )
        assertEquals(
            MagneticFluxDensityConverter.microTeslaToTesla(
                nedMeasurement2.bx.toDouble() - avgX2).pow(2.0) / 2.0,
            noiseEstimator.varianceX,
            ABSOLUTE_ERROR
        )
        assertEquals(
            MagneticFluxDensityConverter.microTeslaToTesla(
                nedMeasurement2.by.toDouble() - avgY2).pow(2.0) / 2.0,
            noiseEstimator.varianceY,
            ABSOLUTE_ERROR
        )
        assertEquals(
            MagneticFluxDensityConverter.microTeslaToTesla(
                nedMeasurement2.bz.toDouble() - avgZ2).pow(2.0) / 2.0,
    ...
    fun process_whenThirdMeasurement_updatesValues() {
        ...
        val avgX3 = MagneticFluxDensityConverter.microTeslaToTesla(
            (nedMeasurement1.bx.toDouble() + nedMeasurement2.bx.toDouble() + nedMeasurement3.bx.toDouble()) / 3.0)
        assertEquals(avgX3, noiseEstimator.avgX,
            ABSOLUTE_ERROR
        )
        val avgY3 = MagneticFluxDensityConverter.microTeslaToTesla(
            (nedMeasurement1.by.toDouble() + nedMeasurement2.by.toDouble() + nedMeasurement3.by.toDouble()) / 3.0)
        assertEquals(avgY3, noiseEstimator.avgY,
            ABSOLUTE_ERROR
        )
        val avgZ3 = MagneticFluxDensityConverter.microTeslaToTesla(
            (nedMeasurement1.bz.toDouble() + nedMeasurement2.bz.toDouble() + nedMeasurement3.bz.toDouble()) / 3.0)
    ...
    fun process_whenIsCompleteMaxSamplesOnly_returnsTrue() {
        ...
        requireNotNull(avgX)
        assertEquals(MagneticFluxDensityConverter.microTeslaToTesla(
            bx.toDouble()), avgX, ABSOLUTE_ERROR)
        val avgY = processor.averageY
        requireNotNull(avgY)
        assertEquals(MagneticFluxDensityConverter.microTeslaToTesla(
            by.toDouble()), avgY, ABSOLUTE_ERROR)
        val avgZ = processor.averageZ
        requireNotNull(avgZ)
        assertEquals(MagneticFluxDensityConverter.microTeslaToTesla(
                bz.toDouble()), avgZ, ABSOLUTE_ERROR)
