...
public class BarycentricRationalInterpolatorTest {
    ...
    public void interpolate_whenMismatchedLength_throwsIllegalArgumentException() {
        ...
        new BarycentricRationalInterpolator(x, y, 1);
    }
    ...
    public void interpolate_whenTooManyPointsToTakeIntoAccount_throwsIllegalArgumentException() {
        ...
        new BarycentricRationalInterpolator(x, y, SAMPLES + 1);
    }

    private void assertInterpolation(final int degree)
            throws InterpolationException, SortingException {
        ...
        final BarycentricRationalInterpolator interpolator =
                new BarycentricRationalInterpolator(x, y, degree + 1);
