...
public class InfinityMidPointQuadratureIntegratorTest {
    ...
    public void integrate_whenGaussian_returnsExpectedResult() throws IntegrationException {
        ...
        final InfinityMidPointQuadratureIntegrator integrator =
                new InfinityMidPointQuadratureIntegrator(a, b,
    ...
    public void getIntegratorType_returnsExpectedValue() {
        final InfinityMidPointQuadratureIntegrator integrator =
                new InfinityMidPointQuadratureIntegrator(0.0, 1.0, null);
