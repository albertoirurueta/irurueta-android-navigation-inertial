...
public class SimpsonTrapezoidalQuadratureMatrixIntegratorTest {
    ...
    public void integrate_whenImproperIntegrandWithSingularities_throwsIntegrationException()
        ...
        final SimpsonTrapezoidalQuadratureMatrixIntegrator integrator =
                new SimpsonTrapezoidalQuadratureMatrixIntegrator(0.0, 1.0, listener);
    ...
    public void integrate_whenImproperIntegralFromZeroToInfinity3_throwsIntegrationException()
        ...
        final SimpsonTrapezoidalQuadratureMatrixIntegrator integrator =
                new SimpsonTrapezoidalQuadratureMatrixIntegrator(0.0, ALMOST_INFINITY, listener);
