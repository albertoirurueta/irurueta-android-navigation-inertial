...
class GyroscopeMeasurementGeneratorProcessorTest {
    ...
    fun processAccelerometerMeasurement_whenInitializingAndNoMeasurements_setsInitialTimestamp() {
        ...
        assertEquals(0.0, timedBodyKinematics.kinematics.angularRateX,
            0.0)
        assertEquals(0.0, timedBodyKinematics.kinematics.angularRateY,
            0.0)
        assertEquals(0.0, timedBodyKinematics.kinematics.angularRateZ,
            0.0)
    ...
    fun processAccelerometerMeasurement_whenInitializingAndAvailableMeasurements_addsTimestamp() {
        ...
        val timedBodyKinematics = slot.captured
        assertEquals(ay.toDouble() + by.toDouble(),
            timedBodyKinematics.kinematics.fx,
            0.0)
        assertEquals(ax.toDouble() + bx.toDouble(),
            timedBodyKinematics.kinematics.fy,
            0.0)
        assertEquals(-az.toDouble() - bz.toDouble(),
            timedBodyKinematics.kinematics.fz,
            0.0)
        assertEquals(0.0, timedBodyKinematics.kinematics.angularRateX,
            0.0)
        assertEquals(0.0, timedBodyKinematics.kinematics.angularRateY,
        ...
        assertEquals(0.0, timedBodyKinematics.kinematics.angularRateZ,
            0.0)
        assertEquals(TimeConverter.nanosecondToSecond(timestamp.toDouble()),
    ...
    fun reset_setsValuesToInitialState() {
        ...
        processor.setPrivateProperty("gyroscopeBaseNoiseLevel", gyroscopeBaseNoiseLevel)
