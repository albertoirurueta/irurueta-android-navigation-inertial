...
//    @MockK(relaxUnitFun = true)
    ...
    @Captor
    private lateinit var gravityGyroscopeAndMagnetometerSyncedSensorMeasurementCaptor: ArgumentCaptor<GravityGyroscopeAndMagnetometerSyncedSensorMeasurement>
...
//        verify(exactly = 1) { gravitySensorCollectorSpy.getMeasurementsBeforePosition(0) }
        ...
        verify(syncedMeasurementListener, times(1)).onSyncedMeasurements(
            eq(syncer),
            capture(gravityGyroscopeAndMagnetometerSyncedSensorMeasurementCaptor)
        )
/*      val slot = slot<GravityGyroscopeAndMagnetometerSyncedSensorMeasurement>()
        ...
        val syncedMeasurement = gravityGyroscopeAndMagnetometerSyncedSensorMeasurementCaptor.value
...
//        verify(exactly = 1) { gravitySensorCollectorSpy.getMeasurementsBeforePosition(0) }
        ...
        verify(staleDetectedMeasurementsListener, times(1)).onStaleMeasurements(
            eq(syncer),
