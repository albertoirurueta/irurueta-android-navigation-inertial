...
public class MidPointQuadratureMatrixIntegratorTest {
    ...
    public void integrate_whenGaussian_returnsExpectedResult()
        ...
        final MidPointQuadratureMatrixIntegrator integrator =
                new MidPointQuadratureMatrixIntegrator(a, b, listener);
    ...
    public void integrate_whenImproperIntegrandWithSingularities_returnsExpectedResult()
        ...
        final MidPointQuadratureMatrixIntegrator integrator =
                new MidPointQuadratureMatrixIntegrator(0.0, 1.0, listener);
    ...
    public void integrate_whenImproperIntegralFromZeroToInfinity3_returnsWrongResult()
        ...
        final MidPointQuadratureMatrixIntegrator integrator =
                new MidPointQuadratureMatrixIntegrator(0.0, ALMOST_INFINITY, listener);
