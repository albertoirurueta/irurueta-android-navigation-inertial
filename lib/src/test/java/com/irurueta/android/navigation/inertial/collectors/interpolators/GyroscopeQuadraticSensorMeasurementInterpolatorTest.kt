...
class GyroscopeQuadraticSensorMeasurementInterpolatorTest {
    ...
    fun constructor_whenEmpty_setsExpectedProperties() {
        val interpolator = GyroscopeQuadraticSensorMeasurementInterpolator()
    ...
    fun constructor_whenNotEmpty_setsExpectedProperties() {
        val interpolator = GyroscopeQuadraticSensorMeasurementInterpolator(false)
    ...
    fun push_whenOnce_setsExpectedValues() {
        ...
        // check
        val measurement2b: GyroscopeSensorMeasurement? = getPrivateProperty(
            QuadraticSensorMeasurementInterpolator::class,
            interpolator,
            "measurement2"
        )
    ...
    fun push_whenTwice_setsExpectedValues() {
        ...
        val measurement1b: GyroscopeSensorMeasurement? = getPrivateProperty(
            QuadraticSensorMeasurementInterpolator::class,
            interpolator,
            "measurement1"
        )
    ...
    fun push_whenThreeTimes_setsExpectedValues() {
        ...
        val measurement0b: GyroscopeSensorMeasurement? = getPrivateProperty(
            QuadraticSensorMeasurementInterpolator::class,
            interpolator,
            "measurement0"
        )
    ...
    fun interpolate_whenNotInitializedAndCopyIfNotInitializedDisabled_returnsFalse() {
        val interpolator =
            GyroscopeQuadraticSensorMeasurementInterpolator(copyIfNotInitialized = false)
    ...
    fun interpolate_whenNotInitializedAndCopyIfNotInitializedEnabled_returnsFalse() {
        val interpolator =
            GyroscopeQuadraticSensorMeasurementInterpolator(copyIfNotInitialized = true)
    ...
    private companion object {
        ...
        fun assertMeasurement(
            ...
            assertEquals(measurement1.wx, measurement2.wx, ABSOLUTE_ERROR)
            assertEquals(measurement1.wy, measurement2.wy, ABSOLUTE_ERROR)
            assertEquals(measurement1.wz, measurement2.wz, ABSOLUTE_ERROR)
        ...
        fun generateMeasurement(
            ...
            val x2 = x * x
            val wx = (a[0] * x2 + b[0] * x + c[0]).toFloat()
            val wy = (a[1] * x2 + b[1] * x + c[1]).toFloat()
            val wz = (a[2] * x2 + b[2] * x + c[2]).toFloat()
            val bx = if (withBias) {
        ...
        fun generateMeasurement(withBias: Boolean = true): GyroscopeSensorMeasurement {
            val randomizer = UniformRandomizer()
            val a = randomizer.nextDoubles(SIZE)
            val b = randomizer.nextDoubles(SIZE)
            val c = randomizer.nextDoubles(SIZE)
