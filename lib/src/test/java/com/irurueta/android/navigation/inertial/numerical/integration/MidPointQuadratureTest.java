...
public class MidPointQuadratureTest {
    ...
    public void next_returnsNotZeroValue() throws EvaluationException {
        ...
        final MidPointQuadrature quadrature = new MidPointQuadrature(a, b,
                polynomial::evaluate);
    ...
    public void getType_returnsExpectedValue() {
        final MidPointQuadrature quadrature = new MidPointQuadrature(0.0, 1.0, null);
