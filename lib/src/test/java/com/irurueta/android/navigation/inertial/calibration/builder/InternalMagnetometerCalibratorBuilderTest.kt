...
class InternalMagnetometerCalibratorBuilderTest {
    ...
    fun constructor_whenRequiredValues_setsExpectedValues() {
        ...
        val builder = InternalMagnetometerCalibratorBuilder(
            measurements,
        ...
        assertEquals(
            InternalMagnetometerCalibratorBuilder.ROBUST_DEFAULT_CONFIDENCE,
            builder.robustConfidence,
            0.0
        )
        assertEquals(
            InternalMagnetometerCalibratorBuilder.ROBUST_DEFAULT_MAX_ITERATIONS,
            builder.robustMaxIterations
        )
        assertNull(builder.robustThreshold)
        assertEquals(
            InternalMagnetometerCalibratorBuilder.DEFAULT_ROBUST_STOP_THRESHOLD_FACTOR,
    ...
    fun robustPreliminarySubsetSize_whenInvalid_throwsIllegalArgumentException() {
        ...
        val measurements = emptyList<StandardDeviationBodyMagneticFluxDensity>()
        val robustPreliminarySubsetSize = -1
        val minimumRequiredMeasurements =
            randomizer.nextInt(robustPreliminarySubsetSize, ROBUST_PRELIMINARY_SUBSET_SIZE)

        assertThrows(IllegalArgumentException::class.java) {
            InternalMagnetometerCalibratorBuilder(
                measurements,
                robustPreliminarySubsetSize,
                minimumRequiredMeasurements
            )
    ...
    fun robustThresholdFactor_whenValid_setsExpectedValue() {
        ...
        // check default value
        assertEquals(
            InternalMagnetometerCalibratorBuilder.DEFAULT_ROBUST_THRESHOLD_FACTOR,
    ...
    fun build_whenNonRobustGroundTruthHardIronSetAndNoCommonAxisWithLocation_buildsExpectedCalibrator() {
        ...
        assertTrue(internalCalibrator2.nedPosition.equals(nedPosition,
            ABSOLUTE_ERROR))
