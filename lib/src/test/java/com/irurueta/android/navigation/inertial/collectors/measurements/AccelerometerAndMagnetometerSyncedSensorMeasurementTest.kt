...
class AccelerometerAndMagnetometerSyncedSensorMeasurementTest {
    ...
    fun constructor_whenCopy_setsExpectedValues() {
        ...
        val syncedMeasurement1 = AccelerometerAndMagnetometerSyncedSensorMeasurement(
            accelerometerMeasurement,
            magnetometerMeasurement,
            timestamp
        )

        val syncedMeasurement2 = AccelerometerAndMagnetometerSyncedSensorMeasurement(syncedMeasurement1)
    ...
    fun copyFrom_whenAllData_makesExpectedCopy() {
        ...
        val syncedMeasurement2 = AccelerometerAndMagnetometerSyncedSensorMeasurement()
    ...
    fun toNedOrThrow_whenAllMeasurementsAreENU_returnsExpectedValue() {
        ...
        val enuSyncedMeasurement = AccelerometerAndMagnetometerSyncedSensorMeasurement(
        ...
        val nedSyncedMeasurement2 = AccelerometerAndMagnetometerSyncedSensorMeasurement(
    ...
    fun toNedOrThrow_whenNEDAccelerometerMeasurement_throwsIllegalArgumentException() {
        ...
        val wrongSyncedMeasurement = AccelerometerAndMagnetometerSyncedSensorMeasurement(
    ...
    @Test
    fun toEnuOrThrow_whenAllMeasurementsAreENU_returnsExpectedValue() {
        val randomizer = UniformRandomizer()
        val ax = randomizer.nextFloat()
        val ay = randomizer.nextFloat()
        val az = randomizer.nextFloat()
        ...
        val nedSyncedMeasurement = AccelerometerAndMagnetometerSyncedSensorMeasurement(
        ...
        val enuSyncedMeasurement2 = AccelerometerAndMagnetometerSyncedSensorMeasurement(
            AccelerometerSensorMeasurement(),
            MagnetometerSensorMeasurement(),
            timestamp
        )
