...
class GyroscopeLinearSensorMeasurementInterpolatorTest {
    ...
    fun constructor_whenEmpty_setsExpectedProperties() {
        val interpolator = GyroscopeLinearSensorMeasurementInterpolator()
    ...
    fun constructor_whenNotEmpty_setsExpectedProperties() {
        val interpolator = GyroscopeLinearSensorMeasurementInterpolator(false)
    ...
    fun interpolate_whenNotInitializedAndCopyIfNotInitializedDisabled_returnsFalse() {
        val interpolator =
            GyroscopeLinearSensorMeasurementInterpolator(copyIfNotInitialized = false)
    ...
    fun interpolate_whenNotInitializedAndCopyIfNotInitializedEnabled_returnsFalse() {
        val interpolator =
            GyroscopeLinearSensorMeasurementInterpolator(copyIfNotInitialized = true)
    ...
    private companion object {
        ...
        fun generateMeasurement(
            ...
            val wx = (a[0] * x + b[0]).toFloat()
            val wy = (a[1] * x + b[1]).toFloat()
            val wz = (a[2] * x + b[2]).toFloat()
            val bx = if (withBias) {
                (a[3] * x + b[3]).toFloat()
            } else {
                null
