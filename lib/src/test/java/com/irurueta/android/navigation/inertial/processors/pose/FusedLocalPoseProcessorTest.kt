...
class FusedLocalPoseProcessorTest {
    ...
    fun constructor_whenAllParameters_returnsExpectedValues() {
        ...
        val processor = FusedLocalPoseProcessor(
            initialLocation,
            initialVelocity,
    ...
    fun process_whenAttitudeTimeIntervalProcessedAndPoseTransformationNotEstimated_returnsTrue() {
        ...
        val gravityMeasurement = GravitySensorMeasurement(gx, gy, gz, timestamp = timestamp)
        ...
        assertEquals(currentNedFrame.latitude, currentNedFrame2.latitude,
            ABSOLUTE_ERROR
        )
        assertEquals(currentNedFrame.longitude, currentNedFrame2.longitude,
            ABSOLUTE_ERROR
        )
        assertEquals(currentNedFrame.height, currentNedFrame2.height,
            LARGE_ABSOLUTE_ERROR
        )
        assertEquals(currentNedFrame.vn, currentNedFrame2.vn,
            LARGE_ABSOLUTE_ERROR
        )
        assertEquals(currentNedFrame.ve, currentNedFrame2.ve,
            LARGE_ABSOLUTE_ERROR
        )
        assertEquals(currentNedFrame.vd, currentNedFrame2.vd,
        ...
        assertEquals(currentEcefFrame2.x, currentEcefFrame3.x,
            LARGE_ABSOLUTE_ERROR
        )
        assertEquals(currentEcefFrame2.y, currentEcefFrame3.y,
            LARGE_ABSOLUTE_ERROR
        )
        assertEquals(currentEcefFrame2.z, currentEcefFrame3.z,
            LARGE_ABSOLUTE_ERROR
        )
        assertEquals(currentEcefFrame2.vx, currentEcefFrame3.vx,
            VERY_LARGE_ABSOLUTE_ERROR
        )
        assertEquals(currentEcefFrame2.vy, currentEcefFrame3.vy,
            VERY_LARGE_ABSOLUTE_ERROR
        )
        assertEquals(currentEcefFrame2.vz, currentEcefFrame3.vz,
            VERY_LARGE_ABSOLUTE_ERROR
        )
