...
class AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollectorTest {
    ...
    private lateinit var measurementListener:
            SyncedSensorCollector.OnMeasurementListener<AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorMeasurement, AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector>

    @MockK(relaxUnitFun = true)
    private lateinit var accelerometerAccuracyChangedListener:
            AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector.OnAccelerometerAccuracyChangedListener

    @MockK(relaxUnitFun = true)
    private lateinit var gravityAccuracyChangedListener:
            AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector.OnGravityAccuracyChangedListener

    @MockK(relaxUnitFun = true)
    private lateinit var gyroscopeAccuracyChangedListener:
            AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector.OnGyroscopeAccuracyChangedListener

    @MockK(relaxUnitFun = true)
    private lateinit var magnetometerAccuracyChangedListener:
            AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector.OnMagnetometerAccuracyChangedListener
    ...
    fun constructor_whenRequiredParameters_setsDefaultValues() {
        ...
        val collector = AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector(context)
        ...
        assertEquals(
            AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector.PrimarySensor.GYROSCOPE,
    ...
    fun constructor_whenAllParameters_setsDefaultValues() {
        ...
        val collector = AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector(
            context,
            ...
            SensorDelay.FASTEST,
            SensorDelay.NORMAL,
            AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector.PrimarySensor.ACCELEROMETER,
            false,
            measurementListener,
        ...
        assertEquals(SensorDelay.FASTEST, collector.gyroscopeSensorDelay)
        assertEquals(SensorDelay.NORMAL, collector.magnetometerSensorDelay)
        assertEquals(
            AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector.PrimarySensor.ACCELEROMETER,
            collector.primarySensor
        )
    ...
    fun primarySensorType_whenAccelerometerUncalibrated_returnsExpectedResult() {
        val collector = AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector(
            context,
            accelerometerSensorType = AccelerometerSensorType.ACCELEROMETER_UNCALIBRATED,
            primarySensor = AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector.PrimarySensor.ACCELEROMETER
        )
    ...
    fun primarySensorType_whenGravity_returnsExpectedResult() {
        val collector = AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector(
            context,
            primarySensor = AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector.PrimarySensor.GRAVITY
        )
    ...
    fun primarySensorType_whenGyroscopeUncalibrated_returnsExpectedResult() {
        val collector = AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector(
            context,
            gyroscopeSensorType = GyroscopeSensorType.GYROSCOPE_UNCALIBRATED,
            primarySensor = AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector.PrimarySensor.GYROSCOPE
        )
    ...
    fun primarySensorType_whenMagnetometerUncalibrated_returnsExpectedResult() {
        val collector = AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector(
            context,
            magnetometerSensorType = MagnetometerSensorType.MAGNETOMETER_UNCALIBRATED,
            primarySensor = AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector.PrimarySensor.MAGNETOMETER
        )
    ...
    fun start_whenAccelerometerRegisterListenerFails_returnsFalse() {
        mockkStatic(SystemClock::class) {
            ...
            val slot4 = slot<SensorEventListener>()
            verify(exactly = 1) {
                sensorManager.registerListener(
                    capture(slot4),
                    magnetometerSensor,
            ...
            assertSame(slot3.captured, slot4.captured)
    ...
    fun stop_whenSensorManager_unregisterListenersAndResetsParameters() {
        ...
        val slot3 = slot<SensorEventListener>()
        verify(exactly = 1) { sensorManager.unregisterListener(capture(slot3), gyroscopeSensor) }
        val slot4 = slot<SensorEventListener>()
        verify(exactly = 1) { sensorManager.unregisterListener(capture(slot4), magnetometerSensor) }
