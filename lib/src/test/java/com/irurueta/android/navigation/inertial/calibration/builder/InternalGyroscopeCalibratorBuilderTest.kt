...
class InternalGyroscopeCalibratorBuilderTest {
    ...
    fun constructor_whenRequiredValues_setsExpectedValues() {
        ...
        val builder = InternalGyroscopeCalibratorBuilder(
            measurements,
        ...
        assertEquals(
            InternalGyroscopeCalibratorBuilder.ROBUST_DEFAULT_CONFIDENCE,
            builder.robustConfidence,
            0.0
        )
        assertEquals(
            InternalGyroscopeCalibratorBuilder.ROBUST_DEFAULT_MAX_ITERATIONS,
            builder.robustMaxIterations
        )
        assertNull(builder.robustThreshold)
        assertEquals(
            InternalGyroscopeCalibratorBuilder.DEFAULT_ROBUST_THRESHOLD_FACTOR,
            builder.robustThresholdFactor,
            0.0
        )
        assertEquals(
            InternalGyroscopeCalibratorBuilder.DEFAULT_ROBUST_STOP_THRESHOLD_FACTOR,
    ...
    fun robustPreliminarySubsetSize_whenInvalid_throwsIllegalArgumentException() {
        ...
        assertThrows(IllegalArgumentException::class.java) {
            InternalGyroscopeCalibratorBuilder(
                measurements,
                robustPreliminarySubsetSize,
                minimumRequiredMeasurements
            )
