...
class GravityAndGyroscopeSyncedSensorCollectorTest {
    ...
    private lateinit var measurementListener:
            SyncedSensorCollector.OnMeasurementListener<GravityAndGyroscopeSyncedSensorMeasurement, GravityAndGyroscopeSyncedSensorCollector>

    @MockK(relaxUnitFun = true)
    private lateinit var gravityAccuracyChangedListener:
            GravityAndGyroscopeSyncedSensorCollector.OnGravityAccuracyChangedListener

    @MockK(relaxUnitFun = true)
    private lateinit var gyroscopeAccuracyChangedListener:
            GravityAndGyroscopeSyncedSensorCollector.OnGyroscopeAccuracyChangedListener
    ...
    fun constructor_whenRequiredParameters_setsDefaultValues() {
        ...
        val collector = GravityAndGyroscopeSyncedSensorCollector(context)
        ...
        assertEquals(
            GravityAndGyroscopeSyncedSensorCollector.PrimarySensor.GYROSCOPE,
    ...
    fun constructor_whenAllParameters_setsDefaultValues() {
        ...
        val collector = GravityAndGyroscopeSyncedSensorCollector(
            context,
            DEFAULT_WINDOW_NANOSECONDS,
            GyroscopeSensorType.GYROSCOPE,
            SensorDelay.NORMAL,
            SensorDelay.GAME,
            GravityAndGyroscopeSyncedSensorCollector.PrimarySensor.GRAVITY,
            false,
            measurementListener,
    ...
    fun primarySensorType_whenGravity_returnsExpectedResult() {
        val collector = GravityAndGyroscopeSyncedSensorCollector(
            context,
            primarySensor = GravityAndGyroscopeSyncedSensorCollector.PrimarySensor.GRAVITY
        )
    ...
    fun primarySensorType_whenGyroscopeUncalibrated_returnsExpectedResult() {
        val collector = GravityAndGyroscopeSyncedSensorCollector(
            context,
            gyroscopeSensorType = GyroscopeSensorType.GYROSCOPE_UNCALIBRATED,
            primarySensor = GravityAndGyroscopeSyncedSensorCollector.PrimarySensor.GYROSCOPE
        )
    ...
    fun createSensorMeasurement_whenUnsupportedSensorEventType_returnsNull() {
        ...
        every { gyroscopeSensor.type }.returns(-1)
