...
class AccelerometerMeasurementGeneratorTest {
    ...
    @MockK
    private lateinit var processor: AccelerometerMeasurementGeneratorProcessor
    ...
    fun constructor_whenNonDefaultValues_setsDefaultValues() {
        ...
        assertEquals(
            SensorDelay.NORMAL,
            generator.accelerometerSensorDelay
        )
        assertSame(
            initializationStartedListener,
    ...
    @Test
    fun start_whenCollectorStartFails_throwsIllegalStateException() {
        mockkStatic(SystemClock::class) {
            val startTimestamp = System.nanoTime()
            every { SystemClock.elapsedRealtimeNanos() }.returns(startTimestamp)
