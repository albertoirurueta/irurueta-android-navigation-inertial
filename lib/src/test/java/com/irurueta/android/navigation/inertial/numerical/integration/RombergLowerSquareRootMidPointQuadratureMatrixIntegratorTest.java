...
public class RombergLowerSquareRootMidPointQuadratureMatrixIntegratorTest {
    ...
    public void integrate_whenGaussian_returnsExpectedResult()
        ...
        final RombergLowerSquareRootMidPointQuadratureMatrixIntegrator integrator =
    ...
    public void integrate_whenImproperIntegrandWithSingularities_returnsExpectedResult()
        ...
        final RombergLowerSquareRootMidPointQuadratureMatrixIntegrator integrator =
                new RombergLowerSquareRootMidPointQuadratureMatrixIntegrator(0.0, 1.0, listener);
