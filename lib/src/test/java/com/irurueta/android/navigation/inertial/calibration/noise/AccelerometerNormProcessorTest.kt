...
class AccelerometerNormProcessorTest {

    @Test
    fun constructor_whenDefaultValues_setsExpectedValues() {
        val processor = AccelerometerNormProcessor()
    ...
    fun constructor_whenNegativeMaxSamples_throwsIllegalArgumentException() {
        assertThrows(IllegalArgumentException::class.java) {
            AccelerometerNormProcessor(-1)
        }
    }

    @Test
    fun constructor_whenMaxSamples_setsExpectedValues() {
        val processor = AccelerometerNormProcessor(MAX_SAMPLES)
    ...
    fun constructor_whenNegativeMaxDurationMillis_throwsIllegalArgumentException() {
        assertThrows(IllegalArgumentException::class.java) {
            AccelerometerNormProcessor(maxDurationMillis = -1L)
        }
    }
    ...
    fun timeIntervalStandardDeviationAsTime_whenResultAvailable_returnsExpectedValue() {
        ...
        assertEquals(
            ...
            timeIntervalStandardDeviationAsTime.value.toDouble(), ABSOLUTE_ERROR
        )
    ...
    fun getTimeIntervalStandardDeviationAsTime_whenResultAvailable_returnsTrue() {
        ...
        assertEquals(timeIntervalStandardDeviation, result.value.toDouble(), ABSOLUTE_ERROR)
        assertEquals(TimeUnit.SECOND, result.unit)
    }
    ...
    fun getNormStandardDeviationAsMeasurement_whenResultAvailable_returnsTrue() {
        ...
        assertEquals(normStandardDeviation, result.value.toDouble(), ABSOLUTE_ERROR)
        assertEquals(AccelerationUnit.METERS_PER_SQUARED_SECOND, result.unit)
    }
    ...
    fun process_whenIsCompleteMaxSamplesOnly_returnsTrue() {
        ...
        assertEquals(TIME_INTERVAL_SECONDS, averageTimeInterval,
    ...
    fun reset_whenMaxDurationOnlyStopMode_resetsValues() {
        val processor = AccelerometerNormProcessor(stopMode = StopMode.MAX_DURATION_ONLY)
    ...
    fun reset_whenOtherStopMode_resetsValues() {
        val processor = AccelerometerNormProcessor(stopMode = StopMode.MAX_SAMPLES_ONLY)
        val maxSamples = processor.maxSamples
