...
import com.irurueta.android.navigation.inertial.old.estimators.pose.LocalPoseEstimator
...
class LocalPoseEstimatorTest {
    ...
    private fun getCurrentLocation(): Location {
        val scenario = ActivityScenario.launch(LocationActivity::class.java).use {
            it.onActivity { activity ->
                this@LocalPoseEstimatorTest.activity = activity
    ...
    private fun logTranslation(currentEcefFrame: ECEFFrame, initialEcefFrame: ECEFFrame) {
        ...
        Log.d("LocalPoseEstimatorTest", "Translation: $distance meters")
    }
}