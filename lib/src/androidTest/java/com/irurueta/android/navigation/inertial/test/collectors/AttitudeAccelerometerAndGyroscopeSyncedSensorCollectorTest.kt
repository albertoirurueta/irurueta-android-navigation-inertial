...
class AttitudeAccelerometerAndGyroscopeSyncedSensorCollectorTest {
    ...
    @RequiresRealDevice
    @Test
    fun attitudeSensor_whenAbsoluteAttitudeSensorType_returnsSensor() {
    ...
    @RequiresRealDevice
    @Test
    fun attitudeSensor_whenRelativeAttitudeSensorType_returnsSensor() {
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val collector = AttitudeAccelerometerAndGyroscopeSyncedSensorCollector(
            context,
    ...
    @RequiresRealDevice
    @Test
    fun attitudeSensorAvailable_whenAbsoluteAttitudeSensorType_returnsTrue() {
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val collector = AttitudeAccelerometerAndGyroscopeSyncedSensorCollector(
            context,
            attitudeSensorType = AttitudeSensorType.ABSOLUTE_ATTITUDE
    ...
    @RequiresRealDevice
    @Test
    fun attitudeSensorAvailable_whenRelativeAttitudeSensorType_returnsTrue() {
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val collector = AttitudeAccelerometerAndGyroscopeSyncedSensorCollector(
            context,
            attitudeSensorType = AttitudeSensorType.RELATIVE_ATTITUDE
    ...
    @RequiresRealDevice
    @Test
    fun startAndStop_whenAbsoluteAttitudeAccelerometerAndGyroscopeSensors_collectsMeasurements() {
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val collector = AttitudeAccelerometerAndGyroscopeSyncedSensorCollector(
            context,
            attitudeSensorType = AttitudeSensorType.ABSOLUTE_ATTITUDE,
            ...
            measurementListener = { _, measurement ->
                ...
                val attitudeMeasurement = measurement.attitudeMeasurement
                requireNotNull(attitudeMeasurement)
                ...
                val a = attitudeMeasurement.attitude.a
                val b = attitudeMeasurement.attitude.b
                val c = attitudeMeasurement.attitude.b
                val d = attitudeMeasurement.attitude.d
                val attitudeTimestamp = attitudeMeasurement.timestamp
                val attitudeAccuracy = attitudeMeasurement.accuracy
                val attitudeSensorType = attitudeMeasurement.sensorType
                val attitudeCoordinateSystem = attitudeMeasurement.sensorCoordinateSystem
                ...
                assertEquals(AttitudeSensorType.ABSOLUTE_ATTITUDE, attitudeSensorType)
                assertEquals(SensorCoordinateSystem.ENU, attitudeCoordinateSystem)
                ...
                Log.d(
                    ...
                    """onMeasurement - timestamp: $timestamp, 
                        |attitude.a: $a, attitude.b: $b, attitude.c: $c, attitude.d: $d,
                        |attitudeTimestamp: $attitudeTimestamp,
                        |attitudeAccuracy: $attitudeAccuracy,
                        |attitudeSensorType: $attitudeSensorType,
                        |attitudeCoordinateSystem: $attitudeCoordinateSystem
    ...
    @RequiresRealDevice
    @Test
    fun startAndStop_whenRelativeAttitudeAccelerometerAndGyroscopeUncalibratedSensors_collectsMeasurements() {
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val collector = AttitudeAccelerometerAndGyroscopeSyncedSensorCollector(
            context,
            attitudeSensorType = AttitudeSensorType.RELATIVE_ATTITUDE,
            ...
            measurementListener = { _, measurement ->
                ...
                assertEquals(AttitudeSensorType.RELATIVE_ATTITUDE, attitudeSensorType)
                assertEquals(SensorCoordinateSystem.ENU, attitudeCoordinateSystem)

                assertNotNull(abx)
                assertNotNull(aby)
                assertNotNull(abz)
                assertEquals(AccelerometerSensorType.ACCELEROMETER_UNCALIBRATED, accelerometerSensorType)
                assertEquals(SensorCoordinateSystem.ENU, accelerometerCoordinateSystem)
