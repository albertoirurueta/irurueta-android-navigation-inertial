...
import com.irurueta.android.navigation.inertial.collectors.AccelerometerGravityAndMagnetometerSyncedSensorCollector
...
class AccelerometerGravityAndMagnetometerSyncedSensorCollectorTest {
    ...
    @RequiresRealDevice
    @Test
    fun startAndStop_whenAccelerometerGravityAndMagnetometerSensors_collectsMeasurements() {
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val collector = AccelerometerGravityAndMagnetometerSyncedSensorCollector(
            context,
            accelerometerSensorType = AccelerometerSensorType.ACCELEROMETER,
    ...
    @RequiresRealDevice
    @Test
    fun startAndStop_whenAccelerometerGravityAndMagnetometerUncalibratedSensors_collectsMeasurements() {
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val collector = AccelerometerGravityAndMagnetometerSyncedSensorCollector(
            context,
            accelerometerSensorType = AccelerometerSensorType.ACCELEROMETER_UNCALIBRATED,
