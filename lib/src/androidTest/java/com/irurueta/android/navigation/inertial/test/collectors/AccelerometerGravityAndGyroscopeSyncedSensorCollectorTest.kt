...
class AccelerometerGravityAndGyroscopeSyncedSensorCollectorTest {
    ...
    @RequiresRealDevice
    @Test
    fun startAndStop_whenAccelerometerGravityAndGyroscopeSensors_collectsMeasurements() {
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val collector = AccelerometerGravityAndGyroscopeSyncedSensorCollector(
            context,
            accelerometerSensorType = AccelerometerSensorType.ACCELEROMETER,
            ...
            accuracyChangedListener = { _, sensorType, accuracy ->
                Log.d(
                    "AccelerometerGravityAndGyroscopeSyncedSensorCollectorTest",
            ...
            measurementListener = { _, measurement ->
                ...
                Log.d("AccelerometerGravityAndGyroscopeSyncedSensorCollectorTest",
    ...
    @RequiresRealDevice
    @Test
    fun startAndStop_whenAccelerometerGravityAndGyroscopeUncalibratedSensors_collectsMeasurements() {
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val collector = AccelerometerGravityAndGyroscopeSyncedSensorCollector(
            context,
            accelerometerSensorType = AccelerometerSensorType.ACCELEROMETER_UNCALIBRATED,
