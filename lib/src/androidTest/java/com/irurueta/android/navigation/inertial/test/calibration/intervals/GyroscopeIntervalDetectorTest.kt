    ...
    fun startAndStop_detectsIntervals() {
        ...
        val detector = GyroscopeIntervalDetector(
            ...
            initializationStartedListener = {
                Log.i("GyroscopeIntervalDetectorTest", "Initialization started")
            },
            ...
            errorListener = { _, reason ->
                Log.i("GyroscopeIntervalDetectorTest", "Error: $reason")
            },
            staticIntervalDetectedListener = { _, _, _, _, _, _, _ ->
                Log.i("GyroscopeIntervalDetectorTest", "Static interval detected")
            },
            dynamicIntervalDetectedListener = { _, _, _, _, _, _, _, _, _, _, _, _, _ ->
                Log.i("GyroscopeIntervalDetectorTest", "Dynamic interval detected")
            },
            resetListener = {
                Log.i("GyroscopeIntervalDetectorTest", "Reset")
            }
        )
