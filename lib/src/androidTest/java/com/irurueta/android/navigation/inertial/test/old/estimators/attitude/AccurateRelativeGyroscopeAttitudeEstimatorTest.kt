...
import com.irurueta.android.navigation.inertial.old.estimators.attitude.AccurateRelativeGyroscopeAttitudeEstimator
...
class AccurateRelativeGyroscopeAttitudeEstimatorTest {
    ...
    fun startAndStop_whenGyroscopeSensor_estimatesRelativeAttitude() {
        val scenario = ActivityScenario.launch(LocationActivity::class.java).use {
            it.onActivity { activity ->
                this@AccurateRelativeGyroscopeAttitudeEstimatorTest.activity = activity
            }
        }
    ...
    private fun logAttitude(roll: Double?, pitch: Double?, yaw: Double?) {
        Log.d(
            "AccurateRelativeGyroscopeAttitudeEstimatorTest",
