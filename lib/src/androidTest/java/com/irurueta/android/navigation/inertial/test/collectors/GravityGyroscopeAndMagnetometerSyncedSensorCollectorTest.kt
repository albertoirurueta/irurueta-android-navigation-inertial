...
class GravityGyroscopeAndMagnetometerSyncedSensorCollectorTest {
    ...
    @RequiresRealDevice
    @Test
    fun startAndStop_whenGravityGyroscopeAndMagnetometerSensors_collectsMeasurements() {
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val collector = GravityGyroscopeAndMagnetometerSyncedSensorCollector(
            context,
            gyroscopeSensorType = GyroscopeSensorType.GYROSCOPE,
            ...
            gravityAccuracyChangedListener = { _, accuracy ->
                Log.d(
                    "GravityGyroscopeAndMagnetometerSyncedSensorCollectorTest",
    ...
    @RequiresRealDevice
    @Test
    fun startAndStop_whenGravityGyroscopeAndMagnetometerUncalibratedSensors_collectsMeasurements() {
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val collector = GravityGyroscopeAndMagnetometerSyncedSensorCollector(
            context,
            gyroscopeSensorType = GyroscopeSensorType.GYROSCOPE_UNCALIBRATED,
