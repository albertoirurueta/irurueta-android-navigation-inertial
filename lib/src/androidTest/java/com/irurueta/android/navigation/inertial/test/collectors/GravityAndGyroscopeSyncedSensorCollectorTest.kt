...
class GravityAndGyroscopeSyncedSensorCollectorTest {
    ...
    @RequiresRealDevice
    @Test
    fun startAndStop_whenGravityAndGyroscopeSensors_collectsMeasurements() {
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val collector = GravityAndGyroscopeSyncedSensorCollector(
            context,
            gyroscopeSensorType = GyroscopeSensorType.GYROSCOPE,
            ...
            gravityAccuracyChangedListener = { _, accuracy ->
                Log.d(
                    "GravityAndGyroscopeSyncedSensorCollectorTest",
    ...
    @RequiresRealDevice
    @Test
    fun startAndStop_whenGravityAndGyroscopeUncalibratedSensors_collectsMeasurements() {
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val collector = GravityAndGyroscopeSyncedSensorCollector(
            context,
            gyroscopeSensorType = GyroscopeSensorType.GYROSCOPE_UNCALIBRATED,
