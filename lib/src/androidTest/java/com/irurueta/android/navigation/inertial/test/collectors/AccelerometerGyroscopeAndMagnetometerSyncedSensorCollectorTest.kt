...
class AccelerometerGyroscopeAndMagnetometerSyncedSensorCollectorTest {
    ...
    @RequiresRealDevice
    @Test
    fun startAndStop_whenAccelerometerGyroscopeAndMagnetometerSensors_collectsMeasurements() {
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val collector = AccelerometerGyroscopeAndMagnetometerSyncedSensorCollector(
            context,
            accelerometerSensorType = AccelerometerSensorType.ACCELEROMETER,
            ...
            accelerometerAccuracyChangedListener = { _, accuracy ->
                Log.d(
                    "AccelerometerGyroscopeAndMagnetometerSyncedSensorCollectorTest",
    ...
    @RequiresRealDevice
    @Test
    fun startAndStop_whenAccelerometerGyroscopeAndMagnetometerUncalibratedSensors_collectsMeasurements() {
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val collector = AccelerometerGyroscopeAndMagnetometerSyncedSensorCollector(
            context,
            accelerometerSensorType = AccelerometerSensorType.ACCELEROMETER_UNCALIBRATED,
