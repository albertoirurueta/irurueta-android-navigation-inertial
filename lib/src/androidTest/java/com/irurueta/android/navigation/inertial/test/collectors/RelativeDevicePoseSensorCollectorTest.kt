...
import com.irurueta.android.navigation.inertial.collectors.RelativeDevicePoseSensorCollector
...
class RelativeDevicePoseSensorCollectorTest {
    ...
    fun startAndStop_whenAbsoluteAttitudeSensorType_collectsMeasurements() {
        ...
        val collector = RelativeDevicePoseSensorCollector(
            context,
            SensorDelay.FASTEST,
            measurementListener = { rotation, translation, frame, transformation, timestamp, accuracy ->
                ...
                Log.d(
                    "RelativeDevicePoseSensorCollectorTest", "onMeasurement - roll: $roll rad, "
                            + "pitch: $pitch rad, "
                            + "yaw: $yaw rad, "
                            + "x: ${translation.inhomX}"
                            + "y: ${translation.inhomY}"
                            + "z: ${translation.inhomZ}"
            ...
            Log.d(
                "RelativeDevicePoseSensorCollectorTest",
    ...
    private fun logSensor(sensor: Sensor) {
        ...
        Log.d(
            "RelativeDevicePoseSensorCollectorTest", "Sensor - fifoMaxEventCount: $fifoMaxEventCount, "
