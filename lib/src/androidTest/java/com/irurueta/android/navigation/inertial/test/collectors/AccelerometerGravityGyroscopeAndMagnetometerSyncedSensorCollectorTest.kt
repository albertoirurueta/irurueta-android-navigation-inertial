...
class AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollectorTest {
    ...
    @RequiresRealDevice
    @Test
    fun startAndStop_whenAccelerometerGravityGyroscopeAndMagnetometerSensors_collectsMeasurements() {
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val collector = AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector(
            context,
            accelerometerSensorType = AccelerometerSensorType.ACCELEROMETER,
            ...
            accuracyChangedListener = { _, sensorType, accuracy ->
                Log.d(
                    "AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollectorTest",
    ...
    @RequiresRealDevice
    @Test
    fun startAndStop_whenAccelerometerGravityGyroscopeAndMagnetometerUncalibratedSensors_collectsMeasurements() {
        val context = InstrumentationRegistry.getInstrumentation().targetContext
        val collector = AccelerometerGravityGyroscopeAndMagnetometerSyncedSensorCollector(
            context,
            accelerometerSensorType = AccelerometerSensorType.ACCELEROMETER_UNCALIBRATED,
