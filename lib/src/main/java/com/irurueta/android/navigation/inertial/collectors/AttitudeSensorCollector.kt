...
class AttitudeSensorCollector(
    ...
    accuracyChangedListener: OnAccuracyChangedListener<AttitudeSensorMeasurement, AttitudeSensorCollector>? = null,
    measurementListener: OnMeasurementListener<AttitudeSensorMeasurement, AttitudeSensorCollector>? = null
) : SensorCollector<AttitudeSensorMeasurement, AttitudeSensorCollector>(
    context,
    sensorDelay,
    ...
    override fun updateMeasurementWithSensorEvent(
        ...
        return AttitudeSensorEventMeasurementConverter.convert(event, measurement)
    }
