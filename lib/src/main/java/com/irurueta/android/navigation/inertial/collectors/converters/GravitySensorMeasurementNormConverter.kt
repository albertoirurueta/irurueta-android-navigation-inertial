...
/**
 * Converts [com.irurueta.android.navigation.inertial.collectors.measurements.GravitySensorMeasurement] into its norm value.
 */
object GravitySensorMeasurementNormConverter :
    SensorMeasurementNormConverter<GravitySensorMeasurement> {
     ...
     * @return norm value.
     */
    override fun convert(input: GravitySensorMeasurement): Double {
