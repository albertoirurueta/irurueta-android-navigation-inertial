 ...
 */
class SpeedTriad constructor(unit: SpeedUnit = DEFAULT_UNIT) : Triad<SpeedUnit, Speed, SpeedTriad>(unit),
    Cloneable {
    ...
    /**
     * Creates and returns a new instance having exactly the same contents as this instance.
     *
     * @return a copy of this instance.
     */
    override fun copy(): SpeedTriad {
        val result = SpeedTriad()
        copyTo(result)
        return result
    }
