 ...
 */
public class SimpsonLowerSquareRootMidPointQuadratureMatrixIntegrator
        extends SimpsonMatrixIntegrator<LowerSquareRootMidPointMatrixQuadrature> {
    ...
    */
   public SimpsonLowerSquareRootMidPointQuadratureMatrixIntegrator(
