...
import com.irurueta.navigation.inertial.calibration.accelerometer.RobustKnownBiasAndGravityNormAccelerometerCalibrator
import com.irurueta.navigation.inertial.calibration.accelerometer.RobustKnownBiasAndPositionAccelerometerCalibrator
import com.irurueta.navigation.inertial.calibration.accelerometer.RobustKnownGravityNormAccelerometerCalibrator
 ...
 */
class InternalAccelerometerCalibratorBuilder private constructor(
    ...
    constructor(
        ...
        robustMaxIterations: Int = ROBUST_DEFAULT_MAX_ITERATIONS,
        robustThreshold: Double? = null,
        robustThresholdFactor: Double = DEFAULT_ROBUST_THRESHOLD_FACTOR,
        robustStopThresholdFactor: Double = DEFAULT_ROBUST_STOP_THRESHOLD_FACTOR,
    ...
    companion object {
         ...
         * an outlier when using robust calibration methods.
         * By default this is 3.0 times [InternalAccelerometerCalibratorBuilder.baseNoiseLevel],
         * which considering the noise level as the standard deviation of a Gaussian distribution,
         * should account for 99% of the cases.
         * Any measurement having an error greater than that in the estimated solution, will be
         * considered an outlier and be discarded.
         */
