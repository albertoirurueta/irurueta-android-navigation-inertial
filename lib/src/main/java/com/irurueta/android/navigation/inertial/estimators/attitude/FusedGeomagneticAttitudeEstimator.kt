 ...
 * available.
 */
class FusedGeomagneticAttitudeEstimator private constructor(
    ...
    override var gravityEstimationListener: GravityEstimator.OnEstimationListener? = null
        set(value) {
            field = value
            geomagneticAttitudeEstimator.gravityEstimationListener = value
        }
    ...
    private fun buildRelativeAttitudeEstimator() {
        relativeAttitudeEstimator = if (useAccurateRelativeGyroscopeAttitudeEstimator) {
    ...
    fun interface OnAttitudeAvailableListener :
        AbsoluteAttitudeEstimator.OnAttitudeAvailableListener<FusedGeomagneticAttitudeEstimator>
}