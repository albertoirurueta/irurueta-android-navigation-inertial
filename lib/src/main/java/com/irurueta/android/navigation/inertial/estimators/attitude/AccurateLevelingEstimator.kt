...
import com.irurueta.android.navigation.inertial.processors.attitude.AccurateLevelingProcessor
 ...
 * location (which requires location permission), at the expense of higher CPU load to estimate
 * leveling values.
 *
...
class AccurateLevelingEstimator(
    ...
    levelingAvailableListener: OnLevelingAvailableListener<AccurateLevelingEstimator>? = null,
    accuracyChangedListener: OnAccuracyChangedListener<AccurateLevelingEstimator>? = null,
    adjustGravityNorm: Boolean = true
) : BaseLevelingEstimator<AccurateLevelingEstimator>(
    context,
    sensorDelay,
    useAccelerometer,
