...
class AccelerometerGyroscopeAndMagnetometerMeasurementGenerator(
    ...
    /**
     * Internal processor to process accelerometer, gyroscope and magnetometer sensor measurements.
     */
    override val processor = AccelerometerGyroscopeAndMagnetometerMeasurementGeneratorProcessor(
        ...
        generatedMagnetometerMeasurementListener = { _, measurement ->
     ...
     * Handles measurements collected by the magnetometer sensor so that they are processed by
     * the internal measurement generator.
     */
