 ...
 */
public class SimpsonLowerSquareRootMidPointQuadratureIntegrator
        extends SimpsonIntegrator<LowerSquareRootMidPointQuadrature> {
     ...
     */
    public SimpsonLowerSquareRootMidPointQuadratureIntegrator(
