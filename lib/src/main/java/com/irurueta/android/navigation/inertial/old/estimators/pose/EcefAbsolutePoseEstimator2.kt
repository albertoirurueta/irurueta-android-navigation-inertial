...
import com.irurueta.android.navigation.inertial.old.processors.pose.AccelerometerDoubleFusedECEFAbsolutePoseProcessor
import com.irurueta.android.navigation.inertial.old.processors.pose.AccelerometerFusedECEFAbsolutePoseProcessor
import com.irurueta.android.navigation.inertial.old.processors.pose.AttitudeECEFAbsolutePoseProcessor
import com.irurueta.android.navigation.inertial.old.processors.pose.DoubleFusedECEFAbsolutePoseProcessor
import com.irurueta.android.navigation.inertial.old.processors.pose.FusedECEFAbsolutePoseProcessor
...
class EcefAbsolutePoseEstimator2(
    ...
    private val fusedProcessor =
        FusedECEFAbsolutePoseProcessor(initialLocation, initialVelocity, estimatePoseTransformation)

    /**
     * Internal processor using fused attitude estimation with accelerometer + pose estimation.
     */
    private val accelerometerFusedProcessor = AccelerometerFusedECEFAbsolutePoseProcessor(
        initialLocation,
        initialVelocity,
    ...
    private val doubleFusedProcessor =
        DoubleFusedECEFAbsolutePoseProcessor(
            initialLocation,
            initialVelocity,
            estimatePoseTransformation
        )
     ...
     * estimation.
     */
    private val accelerometerDoubleFusedProcessor =
        AccelerometerDoubleFusedECEFAbsolutePoseProcessor(
            initialLocation,
            initialVelocity,
            estimatePoseTransformation
        )
     ...
     */
    private val attitudeProcessor = AttitudeECEFAbsolutePoseProcessor(
        initialLocation,
        initialVelocity,
        estimatePoseTransformation
    )
    ...
    fun interface OnPoseAvailableListener {
         ...
         */
        fun onPoseAvailable(
            estimator: EcefAbsolutePoseEstimator2,
