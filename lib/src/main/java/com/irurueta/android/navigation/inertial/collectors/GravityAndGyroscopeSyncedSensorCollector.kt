...
/**
 * Collector that synchronizes gravity and gyroscope measurements.
 *
...
class GravityAndGyroscopeSyncedSensorCollector(
     ...
     * sensor events.
     */
    override val measurement = GravityAndGyroscopeSyncedSensorMeasurement()
    ...
    override val sensors: Collection<Sensor>?
        get() {
            ...
            return if (gravitySensor != null && gyroscopeSensor != null) {
                setOf(gravitySensor, gyroscopeSensor)
            } else {
                null
            }
        }
    ...
    override val sensorsAvailable: Boolean
        get() = gravitySensorAvailable && gyroscopeSensorAvailable
    ...
    override fun processSyncedSample(nowNanoSeconds: Long): Boolean {
        ...
        val valid = if (interpolationEnabled) {
            ...
            if (gravityMeasurement != null && gyroscopeMeasurement != null) {
