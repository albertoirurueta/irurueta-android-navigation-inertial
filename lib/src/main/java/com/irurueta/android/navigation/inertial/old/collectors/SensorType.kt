...
enum class SensorType(val value: Int) {
    ...
    companion object {
        ...
        /**
         * Gets sensor type based on provided [com.irurueta.android.navigation.inertial.collectors.measurements.AccelerometerSensorType].
         *
        ...
        /**
         * Gets sensor type based on provided [com.irurueta.android.navigation.inertial.collectors.measurements.GyroscopeSensorType].
         *
        ...
        /**
         * Gets sensor type based on provided [com.irurueta.android.navigation.inertial.collectors.measurements.MagnetometerSensorType].
         *
        ...
        /**
         * Gets sensor type based on provided [com.irurueta.android.navigation.inertial.collectors.measurements.AttitudeSensorType].
         *
