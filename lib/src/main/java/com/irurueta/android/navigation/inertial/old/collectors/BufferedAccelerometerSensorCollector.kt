...
/**
 * Manages and collects accelerometer sensor measurements using a buffer.
...
class BufferedAccelerometerSensorCollector(
...
) : BufferedSensorCollector<AccelerometerSensorMeasurement, BufferedAccelerometerSensorCollector>(
    context,
    sensorDelay,
    capacity,
    startOffsetEnabled,
    ...
    /**
     * Creates a new instance of a [AccelerometerSensorMeasurement] measurement.
     */
    override fun createEmptyMeasurement(): AccelerometerSensorMeasurement {
