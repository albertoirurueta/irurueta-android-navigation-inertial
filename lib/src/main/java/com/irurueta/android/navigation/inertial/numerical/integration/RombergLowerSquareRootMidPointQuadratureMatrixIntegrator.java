 ...
 *
 * @see LowerSquareRootMidPointMatrixQuadrature
 */
public class RombergLowerSquareRootMidPointQuadratureMatrixIntegrator
        extends RombergMatrixIntegrator<LowerSquareRootMidPointMatrixQuadrature> {
     ...
     */
    public RombergLowerSquareRootMidPointQuadratureMatrixIntegrator(
