 ...
 */
public class SimpsonUpperSquareRootMidPointQuadratureIntegrator
        extends SimpsonIntegrator<UpperSquareRootMidPointQuadrature> {
     ...
     */
    public SimpsonUpperSquareRootMidPointQuadratureIntegrator(
