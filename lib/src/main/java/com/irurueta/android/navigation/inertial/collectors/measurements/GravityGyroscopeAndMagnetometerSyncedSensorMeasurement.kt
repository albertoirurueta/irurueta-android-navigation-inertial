...
class GravityGyroscopeAndMagnetometerSyncedSensorMeasurement(
    ...
    timestamp: Long = 0L
) : SyncedSensorMeasurement<GravityGyroscopeAndMagnetometerSyncedSensorMeasurement>(
    timestamp
), WithGravitySensorMeasurement, WithGyroscopeSensorMeasurement, WithMagnetometerSensorMeasurement {
    /**
     * Copy constructor.
     *
     * @param other instance to copy from.
     */
    constructor(other: GravityGyroscopeAndMagnetometerSyncedSensorMeasurement) : this() {
        copyFrom(other)
    }
     ...
     */
    override fun copyFrom(other: GravityGyroscopeAndMagnetometerSyncedSensorMeasurement) {
     ...
     */
    override fun copy(): GravityGyroscopeAndMagnetometerSyncedSensorMeasurement {
        val result = GravityGyroscopeAndMagnetometerSyncedSensorMeasurement()
        copyTo(result)
        return result
    }
    ...
    override fun toNedOrThrow(result: GravityGyroscopeAndMagnetometerSyncedSensorMeasurement) {
        // check requirements
     ...
     */
    @Throws(IllegalArgumentException::class)
    override fun toNedOrThrow(): GravityGyroscopeAndMagnetometerSyncedSensorMeasurement {
        val output = GravityGyroscopeAndMagnetometerSyncedSensorMeasurement()
        toNedOrThrow(output)
        return output
    }
     ...
     */
    @Throws(IllegalArgumentException::class)
    override fun toEnuOrThrow(result: GravityGyroscopeAndMagnetometerSyncedSensorMeasurement) {
        // check requirements
        val gravityMeasurement = this.gravityMeasurement
        if (gravityMeasurement != null) {
     ...
     */
    @Throws(IllegalArgumentException::class)
    override fun toEnuOrThrow(): GravityGyroscopeAndMagnetometerSyncedSensorMeasurement {
        val output = GravityGyroscopeAndMagnetometerSyncedSensorMeasurement()
        toEnuOrThrow(output)
        return output
    }
     ...
     * @param result instance where converted synced sensor measurement will be stored.
     */
    override fun toNed(result: GravityGyroscopeAndMagnetometerSyncedSensorMeasurement) {
        val gravityMeasurement = this.gravityMeasurement
        val gyroscopeMeasurement = this.gyroscopeMeasurement
        val magnetometerMeasurement = this.magnetometerMeasurement
     ...
     * @return a new instance containing converted synced sensor measurement.
     */
    override fun toNed(): GravityGyroscopeAndMagnetometerSyncedSensorMeasurement {
        val output = GravityGyroscopeAndMagnetometerSyncedSensorMeasurement()
        toNed(output)
        return output
    }
     ...
     * @param result instance where converted synced sensor measurement will be stored.
     */
    override fun toEnu(result: GravityGyroscopeAndMagnetometerSyncedSensorMeasurement) {
        val gravityMeasurement = this.gravityMeasurement
        val gyroscopeMeasurement = this.gyroscopeMeasurement
        val magnetometerMeasurement = this.magnetometerMeasurement
     ...
     * @return a new instance containing converted synced sensor measurement.
     */
    override fun toEnu(): GravityGyroscopeAndMagnetometerSyncedSensorMeasurement {
        val output = GravityGyroscopeAndMagnetometerSyncedSensorMeasurement()
        toEnu(output)
        return output
    }
    ...
    override fun equals(other: Any?): Boolean {
        return super.equals(other) && (other is GravityGyroscopeAndMagnetometerSyncedSensorMeasurement) &&
