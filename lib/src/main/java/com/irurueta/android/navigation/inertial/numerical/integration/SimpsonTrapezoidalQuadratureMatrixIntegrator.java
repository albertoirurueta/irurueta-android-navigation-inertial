 ...
 * {@link SimpsonTrapezoidalQuadratureMatrixIntegrator} will in general be more efficient than
 * {@link TrapezoidalQuadratureMatrixIntegrator} (i.e. require fewer function evaluations) when the
