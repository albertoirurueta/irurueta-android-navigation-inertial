...
/**
 * Converts [SensorEvent] data into an [com.irurueta.android.navigation.inertial.collectors.measurements.GravitySensorMeasurement].
 */
object GravitySensorMeasurementConverter {
    /**
     * Converts [SensorEvent] data into a [com.irurueta.android.navigation.inertial.collectors.measurements.GravitySensorMeasurement] by setting proper values
