...
class GravityAndGyroscopeSyncedSensorMeasurement(
     ...
     */
    constructor(other: GravityAndGyroscopeSyncedSensorMeasurement) : this() {
        copyFrom(other)
    }
     ...
     */
    override fun copyFrom(other: GravityAndGyroscopeSyncedSensorMeasurement) {
     ...
     */
    override fun copy(): GravityAndGyroscopeSyncedSensorMeasurement {
        val result = GravityAndGyroscopeSyncedSensorMeasurement()
        copyTo(result)
        return result
    }
    ...
    override fun toNedOrThrow(result: GravityAndGyroscopeSyncedSensorMeasurement) {
        // check requirements
     ...
     */
    @Throws(IllegalArgumentException::class)
    override fun toNedOrThrow(): GravityAndGyroscopeSyncedSensorMeasurement {
        val output = GravityAndGyroscopeSyncedSensorMeasurement()
        toNedOrThrow(output)
        return output
    }
     ...
     */
    @Throws(IllegalArgumentException::class)
    override fun toEnuOrThrow(result: GravityAndGyroscopeSyncedSensorMeasurement) {
        // check requirements
        val gravityMeasurement = this.gravityMeasurement
        if (gravityMeasurement != null) {
     ...
     */
    @Throws(IllegalArgumentException::class)
    override fun toEnuOrThrow(): GravityAndGyroscopeSyncedSensorMeasurement {
        val output = GravityAndGyroscopeSyncedSensorMeasurement()
        toEnuOrThrow(output)
        return output
    }
     ...
     * @param result instance where converted synced sensor measurement will be stored.
     */
    override fun toNed(result: GravityAndGyroscopeSyncedSensorMeasurement) {
        val gravityMeasurement = this.gravityMeasurement
        val gyroscopeMeasurement = this.gyroscopeMeasurement
     ...
     * @return a new instance containing converted synced sensor measurement.
     */
    override fun toNed(): GravityAndGyroscopeSyncedSensorMeasurement {
        val output = GravityAndGyroscopeSyncedSensorMeasurement()
        toNed(output)
        return output
    }
     ...
     * @param result instance where converted synced sensor measurement will be stored.
     */
    override fun toEnu(result: GravityAndGyroscopeSyncedSensorMeasurement) {
        val gravityMeasurement = this.gravityMeasurement
        val gyroscopeMeasurement = this.gyroscopeMeasurement
     ...
     * @return a new instance containing converted synced sensor measurement.
     */
    override fun toEnu(): GravityAndGyroscopeSyncedSensorMeasurement {
        val output = GravityAndGyroscopeSyncedSensorMeasurement()
        toEnu(output)
        return output
    }
    ...
    override fun equals(other: Any?): Boolean {
        return super.equals(other) && (other is GravityAndGyroscopeSyncedSensorMeasurement) &&
