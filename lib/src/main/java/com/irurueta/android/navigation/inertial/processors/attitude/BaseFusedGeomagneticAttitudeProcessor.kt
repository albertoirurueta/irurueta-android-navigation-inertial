...
abstract class BaseFusedGeomagneticAttitudeProcessor<M : SensorMeasurement<M>, S : SyncedSensorMeasurement>(
    ...
    /**
     * Internal processor to estimate relative attitude.
     */
    private lateinit var relativeGyroscopeProcessor: BaseRelativeGyroscopeAttitudeProcessor
    ...
    internal fun process(
        ...
        if (geomagneticProcessor.process(
            ...
            if (relativeGyroscopeProcessor.process(gyroscopeMeasurement, timestamp)) {
                return processRelativeAttitude(relativeGyroscopeProcessor.attitude)
            }
        }
    ...
    /**
     * Builds internal relative gyroscope attitude processor.
     */
    private fun buildRelativeGyroscopeProcessor() {
        relativeGyroscopeProcessor = if (useAccurateRelativeGyroscopeAttitudeProcessor) {
