...
class LeveledRelativeAttitudeProcessor(
    processorListener: OnProcessedListener<GravitySensorMeasurement, GravityAndGyroscopeSyncedSensorMeasurement>? = null
) : BaseLeveledRelativeAttitudeProcessor<GravitySensorMeasurement, GravityAndGyroscopeSyncedSensorMeasurement>(
    processorListener
) {
    /**
