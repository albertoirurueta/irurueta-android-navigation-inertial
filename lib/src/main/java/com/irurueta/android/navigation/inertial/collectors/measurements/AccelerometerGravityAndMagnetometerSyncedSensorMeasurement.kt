...
/**
 * Contains synced accelerometer, gravity and magnetometer measurements, which are assumed to belong
 * to the same timestamp.
 *
 * @property accelerometerMeasurement an accelerometer measurement. Notice that this instance might
 * be reused between consecutive [AccelerometerGravityAndMagnetometerSyncedSensorMeasurement]
 ...
 * between consecutive [AccelerometerGravityAndMagnetometerSyncedSensorMeasurement] measurements,
 ...
 * assumed to occur.
 */
class AccelerometerGravityAndMagnetometerSyncedSensorMeasurement(
    ...
    timestamp: Long = 0L
) : SyncedSensorMeasurement<AccelerometerGravityAndMagnetometerSyncedSensorMeasurement>(
    timestamp
), WithAccelerometerSensorMeasurement, WithGravitySensorMeasurement,
     ...
     */
    constructor(other: AccelerometerGravityAndMagnetometerSyncedSensorMeasurement) : this() {
        copyFrom(other)
    }
     ...
     */
    override fun copyFrom(other: AccelerometerGravityAndMagnetometerSyncedSensorMeasurement) {
     ...
     */
    override fun copy(): AccelerometerGravityAndMagnetometerSyncedSensorMeasurement {
        val result = AccelerometerGravityAndMagnetometerSyncedSensorMeasurement()
        copyTo(result)
        return result
    }
    ...
    override fun toNedOrThrow(result: AccelerometerGravityAndMagnetometerSyncedSensorMeasurement) {
        // check requirements
     ...
     */
    @Throws(IllegalArgumentException::class)
    override fun toNedOrThrow(): AccelerometerGravityAndMagnetometerSyncedSensorMeasurement {
        val output = AccelerometerGravityAndMagnetometerSyncedSensorMeasurement()
        toNedOrThrow(output)
        return output
    }
     ...
     */
    @Throws(IllegalArgumentException::class)
    override fun toEnuOrThrow(result: AccelerometerGravityAndMagnetometerSyncedSensorMeasurement) {
        // check requirements
        val accelerometerMeasurement = this.accelerometerMeasurement
        if (accelerometerMeasurement != null) {
     ...
     */
    @Throws(IllegalArgumentException::class)
    override fun toEnuOrThrow(): AccelerometerGravityAndMagnetometerSyncedSensorMeasurement {
        val output = AccelerometerGravityAndMagnetometerSyncedSensorMeasurement()
        toEnuOrThrow(output)
        return output
    }
     ...
     * @param result instance where converted synced sensor measurement will be stored.
     */
    override fun toNed(result: AccelerometerGravityAndMagnetometerSyncedSensorMeasurement) {
        val accelerometerMeasurement = this.accelerometerMeasurement
        val gravityMeasurement = this.gravityMeasurement
        val magnetometer = this.magnetometerMeasurement
        ...
        val resultMagnetometerMeasurement = result.magnetometerMeasurement
        if (resultMagnetometerMeasurement != null) {
            magnetometer?.toNed(resultMagnetometerMeasurement)
        }
    }
     ...
     * @return a new instance containing converted synced sensor measurement.
     */
    override fun toNed(): AccelerometerGravityAndMagnetometerSyncedSensorMeasurement {
        val output = AccelerometerGravityAndMagnetometerSyncedSensorMeasurement()
        toNed(output)
        return output
    }
     ...
     * @param result instance where converted synced sensor measurement will be stored.
     */
    override fun toEnu(result: AccelerometerGravityAndMagnetometerSyncedSensorMeasurement) {
        val accelerometerMeasurement = this.accelerometerMeasurement
        val gravityMeasurement = this.gravityMeasurement
        val magnetometerMeasurement = this.magnetometerMeasurement
     ...
     * @return a new instance containing converted synced sensor measurement.
     */
    override fun toEnu(): AccelerometerGravityAndMagnetometerSyncedSensorMeasurement {
        val output = AccelerometerGravityAndMagnetometerSyncedSensorMeasurement()
        toEnu(output)
        return output
    }
    ...
    override fun equals(other: Any?): Boolean {
        return super.equals(other) && (other is AccelerometerGravityAndMagnetometerSyncedSensorMeasurement) &&
