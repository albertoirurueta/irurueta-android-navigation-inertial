...
/**
 * Contains synced attitude and accelerometer measurements, which are assumed to belong to the same
 * timestamp.
 *
 ...
 * assumed to occur.
 */
class AttitudeAndAccelerometerSyncedSensorMeasurement(
    override var attitudeMeasurement: AttitudeSensorMeasurement? = null,
    override var accelerometerMeasurement: AccelerometerSensorMeasurement? = null,
    timestamp: Long = 0L
) : SyncedSensorMeasurement<AttitudeAndAccelerometerSyncedSensorMeasurement>(
    timestamp
), WithAttitudeSensorMeasurement, WithAccelerometerSensorMeasurement {
    /**
     * Copy constructor.
     *
     * @param other instance to copy from.
     */
    constructor(other: AttitudeAndAccelerometerSyncedSensorMeasurement) : this() {
        copyFrom(other)
    }
     ...
     */
    override fun copyFrom(other: AttitudeAndAccelerometerSyncedSensorMeasurement) {
     ...
     */
    override fun copy(): AttitudeAndAccelerometerSyncedSensorMeasurement {
        val result = AttitudeAndAccelerometerSyncedSensorMeasurement()
        copyTo(result)
        return result
    }
    ...
    override fun toNedOrThrow(result: AttitudeAndAccelerometerSyncedSensorMeasurement) {
        // check requirements
     ...
     */
    @Throws(IllegalArgumentException::class)
    override fun toNedOrThrow(): AttitudeAndAccelerometerSyncedSensorMeasurement {
        val output = AttitudeAndAccelerometerSyncedSensorMeasurement()
        toNedOrThrow(output)
        return output
    }
     ...
     */
    @Throws(IllegalArgumentException::class)
    override fun toEnuOrThrow(result: AttitudeAndAccelerometerSyncedSensorMeasurement) {
        // check requirements
        val attitudeMeasurement = this.attitudeMeasurement
        if (attitudeMeasurement != null) {
     ...
     */
    @Throws(IllegalArgumentException::class)
    override fun toEnuOrThrow(): AttitudeAndAccelerometerSyncedSensorMeasurement {
        val output = AttitudeAndAccelerometerSyncedSensorMeasurement()
        toEnuOrThrow(output)
        return output
    }
     ...
     * @param result instance where converted synced sensor measurement will be stored.
     */
    override fun toNed(result: AttitudeAndAccelerometerSyncedSensorMeasurement) {
        val attitudeMeasurement = this.attitudeMeasurement
        val accelerometerMeasurement = this.accelerometerMeasurement
     ...
     * @return a new instance containing converted synced sensor measurement.
     */
    override fun toNed(): AttitudeAndAccelerometerSyncedSensorMeasurement {
        val output = AttitudeAndAccelerometerSyncedSensorMeasurement()
        toNed(output)
        return output
    }
     ...
     * @param result instance where converted synced sensor measurement will be stored.
     */
    override fun toEnu(result: AttitudeAndAccelerometerSyncedSensorMeasurement) {
        val attitudeMeasurement = this.attitudeMeasurement
        val accelerometerMeasurement = this.accelerometerMeasurement
     ...
     * @return a new instance containing converted synced sensor measurement.
     */
    override fun toEnu(): AttitudeAndAccelerometerSyncedSensorMeasurement {
        val output = AttitudeAndAccelerometerSyncedSensorMeasurement()
        toEnu(output)
        return output
    }
    ...
    override fun equals(other: Any?): Boolean {
        return super.equals(other) && (other is AttitudeAndAccelerometerSyncedSensorMeasurement) &&
