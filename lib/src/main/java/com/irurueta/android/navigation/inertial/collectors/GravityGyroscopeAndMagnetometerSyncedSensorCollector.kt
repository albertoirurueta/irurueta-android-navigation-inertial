...
class GravityGyroscopeAndMagnetometerSyncedSensorCollector(
    ...
    accuracyChangedListener: OnAccuracyChangedListener<GravityGyroscopeAndMagnetometerSyncedSensorMeasurement, GravityGyroscopeAndMagnetometerSyncedSensorCollector>? = null
