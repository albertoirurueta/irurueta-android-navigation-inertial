...
/**
 * Magnetometer interpolator.
 */
interface MagnetometerSensorMeasurementInterpolator {
     ...
     */
    fun push(previousMeasurement: MagnetometerSensorMeasurement)
     ...
     */
    fun interpolate(
        currentMeasurement: MagnetometerSensorMeasurement,
        timestamp: Long,
