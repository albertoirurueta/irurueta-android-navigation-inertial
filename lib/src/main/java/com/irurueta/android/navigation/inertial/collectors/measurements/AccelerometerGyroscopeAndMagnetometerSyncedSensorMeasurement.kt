...
/**
 * Contains synced accelerometer, gyroscope and magnetometer measurements, which are assumed to
 ...
 * be reused between consecutive [AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement]
 ...
 * between consecutive [AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement] measurements,
 ...
 * assumed to occur.
 */
class AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement(
    ...
    timestamp: Long = 0L
) : SyncedSensorMeasurement<AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement>(
    timestamp
) {
    /**
     * Copy constructor.
     ...
     */
    constructor(other: AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement) : this() {
        copyFrom(other)
    }
     ...
     */
    override fun copyFrom(other: AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement) {
     ...
     */
    override fun copy(): AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement {
        val result = AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement()
        copyTo(result)
        return result
    }
    ...
    override fun toNedOrThrow(result: AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement) {
        // check requirements
     ...
     */
    @Throws(IllegalArgumentException::class)
    override fun toNedOrThrow(): AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement {
        val output = AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement()
        toNedOrThrow(output)
        return output
    }
     ...
     */
    @Throws(IllegalArgumentException::class)
    override fun toEnuOrThrow(result: AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement) {
        // check requirements
        val accelerometerMeasurement = this.accelerometerMeasurement
        if (accelerometerMeasurement != null) {
     ...
     */
    @Throws(IllegalArgumentException::class)
    override fun toEnuOrThrow(): AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement {
        val output = AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement()
        toEnuOrThrow(output)
        return output
    }
     ...
     * @param result instance where converted synced sensor measurement will be stored.
     */
    override fun toNed(result: AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement) {
        val accelerometerMeasurement = this.accelerometerMeasurement
        val gyroscopeMeasurement = this.gyroscopeMeasurement
        val magnetometerMeasurement = this.magnetometerMeasurement
     ...
     * @return a new instance containing converted synced sensor measurement.
     */
    override fun toNed(): AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement {
        val output = AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement()
        toNed(output)
        return output
    }
     ...
     * @param result instance where converted synced sensor measurement will be stored.
     */
    override fun toEnu(result: AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement) {
        val accelerometerMeasurement = this.accelerometerMeasurement
        val gyroscopeMeasurement = this.gyroscopeMeasurement
        val magnetometerMeasurement = this.magnetometerMeasurement
     ...
     * @return a new instance containing converted synced sensor measurement.
     */
    override fun toEnu(): AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement {
        val output = AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement()
        toEnu(output)
        return output
    }
    ...
    override fun equals(other: Any?): Boolean {
        return super.equals(other) && (other is AccelerometerGyroscopeAndMagnetometerSyncedSensorMeasurement) &&
