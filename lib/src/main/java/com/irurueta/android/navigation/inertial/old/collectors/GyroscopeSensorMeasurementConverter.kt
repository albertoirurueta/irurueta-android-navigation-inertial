...
/**
 * Converts [SensorEvent] data into an [com.irurueta.android.navigation.inertial.collectors.measurements.GyroscopeSensorMeasurement].
 */
object GyroscopeSensorMeasurementConverter {

    /**
     * Converts [SensorEvent] data into a [com.irurueta.android.navigation.inertial.collectors.measurements.GyroscopeSensorMeasurement] by setting proper values
