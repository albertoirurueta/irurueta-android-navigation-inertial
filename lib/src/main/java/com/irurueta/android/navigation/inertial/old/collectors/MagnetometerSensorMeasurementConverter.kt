...
/**
 * Converts [SensorEvent] data into an [com.irurueta.android.navigation.inertial.collectors.measurements.MagnetometerSensorMeasurement].
 */
object MagnetometerSensorMeasurementConverter {

    /**
     * Converts [SensorEvent] data into an [com.irurueta.android.navigation.inertial.collectors.measurements.MagnetometerSensorMeasurement] by setting proper values
