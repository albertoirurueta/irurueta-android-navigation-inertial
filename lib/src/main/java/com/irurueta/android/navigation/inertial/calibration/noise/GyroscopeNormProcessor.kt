 ...
 * processed. In such case, average gyroscope norm should match expected Earth rotation rate.
 *
...
) : AccumulatedMeasurementProcessor<GyroscopeNormProcessor,
        AccumulatedAngularSpeedMeasurementNoiseEstimator,
        AngularSpeedUnit, AngularSpeed, GyroscopeSensorMeasurement>(
    maxSamples, maxDurationMillis, stopMode
) {
    /**
     * Internal noise estimator of angular speed magnitude measurements.
