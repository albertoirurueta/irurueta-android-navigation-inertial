...
/**
 * Accelerometer interpolator that makes no action.
 */
class AccelerometerDirectSensorMeasurementInterpolator :
    DirectSensorMeasurementInterpolator<AccelerometerSensorMeasurement>(),
