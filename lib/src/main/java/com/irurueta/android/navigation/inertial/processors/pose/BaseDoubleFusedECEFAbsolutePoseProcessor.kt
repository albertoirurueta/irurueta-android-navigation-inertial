 ...
 */
abstract class BaseDoubleFusedECEFAbsolutePoseProcessor<M : SensorMeasurement<M>, S : SyncedSensorMeasurement<S>>(
    ...
    override fun processPose(
        ...
        val result =
            super.processPose(accelerometerMeasurement, gyroscopeMeasurement, timestamp, zuptScore)
