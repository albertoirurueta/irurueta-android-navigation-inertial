...
/**
 * Collector that synchronizes gravity and magnetometer measurements.
 *
 ...
 */
class GravityAndMagnetometerSyncedSensorCollector(
    context: Context,
    ...
    val primarySensor: PrimarySensor = PrimarySensor.MAGNETOMETER,
    interpolationEnabled: Boolean = true,
    measurementListener: OnMeasurementListener<GravityAndMagnetometerSyncedSensorMeasurement, GravityAndMagnetometerSyncedSensorCollector>? = null,
    accuracyChangedListener: OnAccuracyChangedListener<GravityAndMagnetometerSyncedSensorMeasurement, GravityAndMagnetometerSyncedSensorCollector>? = null
) : SyncedSensorCollector<GravityAndMagnetometerSyncedSensorMeasurement, GravityAndMagnetometerSyncedSensorCollector>(
    context,
    windowNanoseconds,
     ...
     * sensor events.
     */
    override val measurement = GravityAndMagnetometerSyncedSensorMeasurement()
    ...
    override val sensors: Collection<Sensor>?
        get() {
            ...
            return if (gravitySensor != null && magnetometerSensor != null) {
                setOf(gravitySensor, magnetometerSensor)
            } else {
                null
            }
        }
    ...
    override fun getSensorDelayFor(sensor: Sensor): Int {
        return if (sensor == gravitySensor) {
    ...
    override val sensorsAvailable: Boolean
        get() = gravitySensorAvailable && magnetometerSensorAvailable
    ...
    override fun processSyncedSample(nowNanoSeconds: Long): Boolean {
        ...
        val valid = if (interpolationEnabled) {
            ...
            if (gravityMeasurement != null && magnetometerMeasurement != null) {
