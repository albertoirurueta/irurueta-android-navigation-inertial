 ...
 *
 * @see UpperSquareRootMidPointQuadrature
 */
public class RombergUpperSquareRootMidPointQuadratureIntegrator
        extends RombergIntegrator<UpperSquareRootMidPointQuadrature> {
     ...
     */
    public RombergUpperSquareRootMidPointQuadratureIntegrator(
