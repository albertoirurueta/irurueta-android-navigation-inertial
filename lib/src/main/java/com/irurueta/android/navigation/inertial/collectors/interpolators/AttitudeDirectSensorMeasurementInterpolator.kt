...
/**
 * Attitude interpolator that makes no action.
 */
class AttitudeDirectSensorMeasurementInterpolator :
    DirectSensorMeasurementInterpolator<AttitudeSensorMeasurement>(),
