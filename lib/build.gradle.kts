...
android {
    namespace = "com.irurueta.android.navigation.inertial"
    compileSdk = 36
    ...
    defaultConfig {
        ...
        val apkPrefixLabels = listOf("inertial-navigation", libraryVersion, buildNumber)
...
sonar {
    properties {
        ...
        property("sonar.projectKey", "albertoirurueta_irurueta-android-navigation-inertial")
        property("sonar.projectName", "irurueta-android-navigation-inertial")
...
dependencies {
    ...
    api(libs.irurueta.navigation)
    api(libs.irurueta.navigation.inertial)
    api(libs.irurueta.navigation.inertial.extra)
...
mavenPublishing {
    ...
    coordinates("com.irurueta", "irurueta-android-navigation-inertial", libraryVersion)

    pom {
        name.set("irurueta-android-navigation-inertial")
        description.set("Services and views to support inertial navigation")
        inceptionYear.set("2025")
        url.set("https://github.com/albertoirurueta/irurueta-android-navigation-inertial/")
        licenses {
            license {
                name.set("Apache License 2.0")
                url.set("https://github.com/albertoirurueta/irurueta-android-navigation-inertial/blob/main/LICENSE")
                distribution.set("https://github.com/albertoirurueta/irurueta-android-navigation-inertial/blob/main/LICENSE")
            }
        }
        developers {
            developer {
        ...
        scm {
            url.set("https://github.com/albertoirurueta/irurueta-android-navigation-inertial/")
            connection.set("scm:git:github.com/albertoirurueta/irurueta-android-navigation-inertial.git")
            developerConnection.set("scm:git:ssh://github.com/albertoirurueta/irurueta-android-navigation-inertial.git")
        }
    }
}
